...
public class Jitk2 extends MainLocation2 {
    ...
    private void doAction() {
        ...
        switch (nextActionID) {
            case 1:
                // Eingang anschauen
                krabatSays("Jitk2_1", fEingang, 3, 0, 0);
                break;

            case 2:
                // Wagen anschauen
                krabatSays("Jitk2_2", fWagen, 3, 0, 0);
                break;

            case 50:
                // Wagen mitnehmen
                krabatSays("Jitk2_3", fWagen, 3, 0, 0);
                break;

            case 51:
                // Tuer mitnehmen
                krabatSays("Jitk2_4", fEingang, 3, 0, 0);
                break;

            case 100:
                // Gehe zu Doma
                createNewLocation(71, 74);
                break;

            case 101:
                // gehe zu Les1
                createNewLocation(78, 74);
                break;

            case 102:
                // nach Ralbitz gehen
                createNewLocation(82, 74);
                break;
