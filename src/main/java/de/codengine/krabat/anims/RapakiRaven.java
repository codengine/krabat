...
public class RapakiRaven extends MainAnim {
    ...
    // Erzeugen
    public RapakiRaven(Start caller, int x, int y, int XEnde) {
        super(caller);
        this.x = x;
        this.y = y;
        this.XEnde = XEnde;
    ...
    public RapakiRaven(Start caller, int x, int y, int Zoomfaktor, int XEnde) {
        super(caller);
        this.x = x;
        this.y = y;
    ...
    public RapakiRaven(Start caller, int x, int y, int Zoomfaktor, int XEnde, boolean isNeverGleiting) {
        super(caller);
        this.x = x;
        this.y = y;
        this.Zoomfaktor = Zoomfaktor;
