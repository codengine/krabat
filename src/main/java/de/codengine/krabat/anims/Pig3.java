...
public class Pig3 extends MainAnim {
    ...
    public Pig3(Start caller, GenericPoint Posit) {
        super(caller);
    ...
    private void InitImages() {
        ...
        swinjo_look[3] = getPicture("gfx/most/swino3c.png");
        swinjo_look[4] = getPicture("gfx/most/swino3d.png");

        swinjo_dance[0] = getPicture("gfx/most/swino3-d0.png");
        swinjo_dance[1] = getPicture("gfx/most/swino3-d1.png");
        swinjo_dance[2] = getPicture("gfx/most/swino3-d2.png");
        swinjo_dance[3] = getPicture("gfx/most/swino3-d3.png");
    }
    ...
    public void drawSwino(GenericDrawingContext offGraph, boolean isDancing, boolean noSound) {
        ...
        if (!isDancing && !oldDance) {
            ...
            offGraph.drawImage(swinjo_look[Look], Posit.x - untenBreite / 2, Posit.y - untenHoehe);
        }
        ...
        if (isDancing && oldDance) {
            ...
            // zeichnen
            offGraph.setClip(swinoRect());
            offGraph.drawImage(swinjo_dance[tempDance], Posit.x - obenBreite / 2, Posit.y - obenHoehe);
        }

        if (isDancing != oldDance) {
            // Uebergangszustand, gleich zeichnen
            offGraph.setClip(swinoRect());
            offGraph.drawImage(swinjo_dance[0], Posit.x - obenBreite / 2, Posit.y - obenHoehe);
        }
