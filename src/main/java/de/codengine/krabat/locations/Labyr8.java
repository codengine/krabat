...
public class Labyr8 extends MainLabyrinth {
    ...
    public Labyr8(Start caller, int oldLocation) {
        ...
        bludPoint = new GenericPoint(485, 363);  // hier Krabats Punkt fuer Blud!!!
        bludFacing = 3;
        locIndex = 58;
    ...
    private void initLocation(int oldLocation) {
        ...
        mainFrame.pathWalker.vBorders.addElement(new BorderTrapezoid(347, 380, 331, 408, 306, 345));
        mainFrame.pathWalker.vBorders.addElement(new BorderTrapezoid(329, 358, 347, 380, 274, 305));
    ...
    private void initImages() {
        background = getPicture("gfx/labyrinth/laby8.png");
        lab82 = getPicture("gfx/labyrinth/lab8-2.png");
