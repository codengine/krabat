...
public class Labyr2 extends MainLabyrinth {
    ...
    public Labyr2(Start caller, int Richtung) {
        ...
        mainFrame.krabat.zoomFactor = 10.01f;
        ...
        bludPoint = new GenericPoint(487, 365);  // Look/Use-Point fuer Krabat
        bludFacing = 3;
        locIndex = 52;
    ...
    private void initLocation(int Richtung) {
        ...
        switch (Richtung) {
            case 0:
                ...
                Ausgang = calculateExit(true, false, false, true);
                break;
            case 3:
                // von links aus
                mainFrame.krabat.setPos(new GenericPoint(26, 370));
                mainFrame.krabat.setFacing(3);
                Ausgang = calculateExit(true, false, false, true);
                break;
            case 9:
                // von rechts aus
                mainFrame.krabat.setPos(new GenericPoint(606, 378));
                mainFrame.krabat.setFacing(9);
                Ausgang = calculateExit(true, false, false, false);
                break;
            case 6:
                // von oben aus
                mainFrame.krabat.setPos(new GenericPoint(289, 288));
                mainFrame.krabat.setFacing(6);
                Ausgang = calculateExit(false, false, false, true);
                break;
        }
    ...
    private void initImages() {
        background = getPicture("gfx/labyrinth/laby2.png");
        lab22 = getPicture("gfx/labyrinth/lab2-2.png");
    ...
    public void paintLocation(GenericDrawingContext g) {
        ...
        // Irrlichter zeichnen
        if (bludVisible) {
            g.setClip(bludRect.topLeftPoint.x, bludRect.topLeftPoint.y, irrlicht.breite, irrlicht.hoehe);
            g.drawImage(background, 0, 0);
            irrlicht.drawBludnicki(g, talkPerson, bludRect.topLeftPoint, doesHeListen, bludNimmt);
        }
        ...
        if (lab22Rect.isPointInRect(pKrTemp)) {
            g.drawImage(lab22, 563, 366);
        }
    ...
    public void evalMouseEvent(GenericMouseEvent e) {
        ...
        // normaler Cursor, normale Reaktion
            ...
            if (e.isLeftClick()) {
                ...
                if (bludRect.isPointInRect(pTemp) && bludVisible) {
                    nextActionID = 50;
                    mainFrame.pathWalker.setNewWay(bludPoint);
                    mainFrame.repaint();
                    return;
                }
