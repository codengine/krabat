...
public class Njedz1 extends MainLocation {
    ...
    public Njedz1(Start caller, int oldLocation) {
        ...
        mainFrame.krabat.zoomFactor = 1.35f;
    ...
    private void doAction() {
        ...
        switch (nextActionID) {
            ...
            case 1:
                // Woda anschauen
                krabatSays("Njedz1_1", fWoda, 3, 0, 0);
                break;

            case 50:
                // Woda mitnehmen
                krabatSays("Njedz1_2", fWoda, 3, 0, 0);
                break;

            case 100:
                // Gehe zu Hojnt
                createNewLocation(14, 15);
                break;

            case 101:
                // gehe zu Villa
                createNewLocation(16, 15);
                break;
            ...
            case 200:
                // Ryba auf Woda
                krabatSays("Njedz1_3", fWoda, 3, 0, 0);
                break;

            case 210:
                // Wuda auf woda
                krabatSays("Njedz1_4", fWoda, 3, 0, 0);
                break;
