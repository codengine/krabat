...
public class Wjerby1 extends MainLocation {
    private static final Logger log = LoggerFactory.getLogger(Wjerby1.class);
    ...
    public Wjerby1(Start caller, int oldLocation) {
        ...
        mainFrame.krabat.zoomFactor = 1.75f;
    ...
    private void initLocation(int oldLocation) {
        ...
        mainFrame.pathFinder.connectPos(2, 5);
    ...
    private void doAction() {
        ...
        switch (nextActionID) {
            case 100:
                // Gehe zu Wjes
                createNewLocation(13, 10);
                break;

            case 101:
                // gehe zu Polo
                createNewLocation(11, 10);
                break;

            case 102:
                // nach Kupa gehen
                createNewLocation(12, 10);
                break;
