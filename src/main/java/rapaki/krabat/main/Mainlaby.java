...
abstract public class Mainlaby extends Mainloc 
{
   	...
   	while (exit == false)
   		...
   		zuffi = (int) Math.round (Math.random() * 12) + 50;
                for (int i = 0; i < BludExitLeft.length; i++)
                    {
                        if ((zuffi == BludExitLeft[i]) && (locIndex != zuffi)) exit = true;
                    }
            }
        newloc = zuffi;  		
    }
   	...
   	while (exit == false)
   		...
   		zuffi = (int) Math.round (Math.random() * 12) + 50;
                for (int i = 0; i < BludExitRight.length; i++)
                    {
                        if ((zuffi == BludExitRight[i]) && (locIndex != zuffi)) exit = true;
                    }
            }  		
        newloc = zuffi;
    }				
   	...
   	while (exit == false)
   		...
   		zuffi = (int) Math.round (Math.random() * 12) + 50;
                for (int i = 0; i < BludExitUp.length; i++)
                    {
                        if ((zuffi == BludExitUp[i]) && (locIndex != zuffi)) exit = true;
                    }
            }
        newloc = zuffi;  		
    }				
   	...
   	while (exit == false)
   		...
   		zuffi = (int) Math.round (Math.random() * 12) + 50;
                for (int i = 0; i < BludExitDown.length; i++)
                    {
                        if ((zuffi == BludExitDown[i]) && (locIndex != zuffi)) exit = true;
                    }
            }
        newloc = zuffi;  		
    }				
    ...
    public int BerechneAusgang (boolean oben, boolean unten, boolean links, boolean rechts)
    {
  	do
  		...
  		if ((zuffi <  30) &&                 (oben  == true))  return (12);
  		if ((zuffi >= 30) && (zuffi < 60) && (unten == true))  return (6);
  		if ((zuffi >= 60) && (zuffi < 90) && (links == true))  return (9);
  		if ((zuffi >= 90) &&                 (rechts == true)) return (3);
            }
        while (true);
    }  	
    ...
    public void Erscheinen (boolean blink)
    {
  	...
  	if ((mainFrame.Actions[236] == false) && (mainFrame.Actions[235] == false))
  		...
  		while (mainFrame.Actions[i] == true) i++;
  	...
  	if ((blink == true) && (mainFrame.Actions[236] == true))
  		...
  		while (mainFrame.Actions[x] == true) x++;
    ...
    public void BludAction (int AID)
    {
		...
		mainFrame.krabat.SetFacing (bludFacing);
            ...
            case 156:
                ...
                if (mainFrame.krabat.nAnimation == 0) nextActionID = 157;
                bludNimmt = true;
                break;  
                ...
                if (mainFrame.sprache == 1)
                    {
                        ...
                        if (mainFrame.Actions[184] == false) Dialog.ExtendMC (Start.stringManager.getTranslation("Main_Mainlaby_00016"),182, 183, new int[] {183, 195}, 640);
                        else                                 Dialog.ExtendMC (Start.stringManager.getTranslation("Main_Mainlaby_00017"), 182, 183, new int[] {183, 195}, 640);
                ...
                if (mainFrame.sprache == 2)
                    {
                        ...
                        if (mainFrame.Actions[184] == false) Dialog.ExtendMC (Start.stringManager.getTranslation("Main_Mainlaby_00026"),182, 183, new int[] {183, 195}, 640);
                        else                                 Dialog.ExtendMC (Start.stringManager.getTranslation("Main_Mainlaby_00027"), 182, 183, new int[] {183, 195}, 640);
                ...
                if (mainFrame.sprache == 3)
                    {
                        ...
                        if (mainFrame.Actions[184] == false) Dialog.ExtendMC (Start.stringManager.getTranslation("Main_Mainlaby_00036"),182, 183, new int[] {183, 195}, 640);
                        else                                 Dialog.ExtendMC (Start.stringManager.getTranslation("Main_Mainlaby_00037"), 182, 183, new int[] {183, 195}, 640);
		...
		if ((mainFrame.Actions[183] == true) && (nextActionID == 630)) mainFrame.Actions[183] = false;
		if ((mainFrame.Actions[196] == true) && (nextActionID == 640)) mainFrame.Actions[196] = false;
