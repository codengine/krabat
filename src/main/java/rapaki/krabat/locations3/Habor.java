...
//             }  
        ...
        if (whichShip == 1) g.drawImage (bootb, 166, 251, null);
        if (whichShip == 2) g.drawImage (boota, 175, 230, null);
        if ((whichShip == 1) || (whichShip == 2)) g.drawImage (steg, 146, 255, null);
    ...
    private void DoAction ()
    {
  	...
  	if ((nextActionID > 119) && (nextActionID < 129))
		...
		isListening = true;
            ...
            case 617:
                // Give eval.
                if (Hakencounter == 5) mainFrame.krabat.nAnimation = 91;
                if ((--Hakencounter) > 1) break;
                giveHaken = false;
                nextActionID = 618;
                break;  
