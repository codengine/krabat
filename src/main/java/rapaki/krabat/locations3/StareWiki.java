...
import rapaki.krabat.anims.PredKorejtow;
import rapaki.krabat.anims.PredMalickow;
import rapaki.krabat.anims.PredWosuskow;
...
public class StareWiki extends Mainloc
{
    ...
    private PredKorejtow predKorejtow;
    private PredWosuskow predWosuskow;
    private PredMalickow predMalickow;
    private Multiple2 Dialog;
 
    private GenericPoint korejtowPoint;
    private GenericPoint talkPointKorejty;
    private Borderrect rePredKorejtow;
  
    private GenericPoint wosuskowPoint;
    private GenericPoint talkPointWosuski;
    private Borderrect rePredWosuskow;
    private boolean wosIsLooking = false;
    private boolean wosIsGiving = false;
  
    private GenericPoint malickowPoint;
    private GenericPoint talkPointMalicki;
    private Borderrect rePredMalickow;
    ...
    public void paintLocation (GenericDrawingContext g)
    {
        ...
        g.drawImage (background, 0, 0, null);
        if ((AnimTalkPerson == 62) && (AnimMCLocked == false))
            {
        ...
        g.setClip (wosuskowPoint.x, wosuskowPoint.y, PredWosuskow.Breite, PredWosuskow.Hoehe);   
        if ((AnimTalkPerson == 63) && (AnimMCLocked == false))
            {
                // bei einer Anim rumschreien lassen
            ...
            { 
                if (TalkPerson == 63)
                    ...
                    {
                        if ((wosIsGiving == true) || (wosIsLooking == true))
                            {
                                // bei irgendwelchen Anims
                                if (wosIsGiving == true) wosIsGiving = predWosuskow.animPredawar (g, 2);
                                if (wosIsLooking == true) wosIsLooking = predWosuskow.animPredawar (g, 1);
                            }
                        else
                            {
                                // beim Rumstehen
        ...
        g.setClip (malickowPoint.x - 5, malickowPoint.y - 3, PredMalickow.Breite + 10, PredMalickow.Hoehe + 6);   
        if ((AnimTalkPerson == 64) && (AnimMCLocked == false))
            {
                // bei einer Anim rumschreien lassen
                if (malIsInvisible == false) predMalickow.callPredawar (g);
            }
        else
            { 
                if (TalkPerson == 64)
                    {
                        // beim Reden
                        if (malIsInvisible == false) predMalickow.talkPredawar (g);
                    }
                else
                    {
                        if ((malIsWalking == true) || (malIsGiving == true))
                            {
                                // bei irgendwelchen Anims
                                if (malIsWalking == true) malIsWalking = predMalickow.animPredawar (g, 1);
                                if ((malIsGiving == true) && (malIsInvisible == false)) 
				    malIsGiving = predMalickow.animPredawar (g, 2);
                            }
                        else
                            {
                                // beim Rumstehen
                                if (malIsInvisible == false) predMalickow.drawPredawar (g, malIsListening);
                            }
                    }
            }
        ...
        if (rectKoleso.IsPointInRect (pKrTemp) == true) {
            g.drawImage (koleso, 337, 271, null);
        }

        // Ausgabe von AnimText, falls noetig
        if  ((AnimOutputText != "") && (AnimMCLocked == false))
            {
                // Textausgabe
                GenericRectangle my;
                my = g.getClipBounds();
        ...
        if ((AnimID != 0) && (AnimMCLocked == false))
            {
                DoAnims();
            }		
    ...
    public void evalMouseEvent (GenericMouseEvent e)
    {
        ...
        if (mainFrame.invCursor == true)
			...
			nextActionID = 0;
                        ...
                        if (rePredWosuskow.IsPointInRect (pTemp) == true)
                            {
                                if (mainFrame.whatItem == 40)
                                    {
                                        nextActionID = 160;
                                    }
                                else nextActionID = 200;
                                pTemp = pPredWosuskow;		
                            }
                
                        // Ausreden fuer PredKorejtow 
                        if (rePredKorejtow.IsPointInRect (pTemp) == true) 
                            {
                                // Extra - Sinnloszeug
                                nextActionID = 155;
                                pTemp = pPredKorejtow;
                        ...
                        if (rePredMalickow.IsPointInRect (pTemp) == true)
                            {
                                switch (mainFrame.whatItem)
                                    {
                                    case 31: // Dowol ohne alles
                                        if ((mainFrame.Actions[647] == false) && (mainFrame.Actions[648] == false)) nextActionID = 1000;
                                        if ((mainFrame.Actions[647] == false) && (mainFrame.Actions[648] == true )) nextActionID = 1070;
                                        if ((mainFrame.Actions[647] == true ) && (mainFrame.Actions[648] == false)) nextActionID = 1040;
                                        if ((mainFrame.Actions[647] == true ) && (mainFrame.Actions[648] == true )) nextActionID = 1090;
                                    ...
                                    case 32: // Dowol zygl.
                                        ...
                                        break;
                                    case 45: // Casnik
                                        if (((mainFrame.Actions[645] == false) && (mainFrame.Actions[646] == false)) && (mainFrame.Actions[647] == false)) nextActionID = 1020;
                                        if (((mainFrame.Actions[645] == false) && (mainFrame.Actions[646] == false)) && (mainFrame.Actions[647] == true )) nextActionID = 1060;
                                        if (((mainFrame.Actions[645] == true ) || (mainFrame.Actions[646] == true )) && (mainFrame.Actions[647] == false)) nextActionID = 1050;
                                        if (((mainFrame.Actions[645] == true ) || (mainFrame.Actions[646] == true )) && (mainFrame.Actions[647] == true )) nextActionID = 1110;
                                        break;
                                    case 49: // Prikaz
                                        if (((mainFrame.Actions[645] == false) && (mainFrame.Actions[646] == false)) && (mainFrame.Actions[648] == false)) nextActionID = 1010;
                                        if (((mainFrame.Actions[645] == false) && (mainFrame.Actions[646] == false)) && (mainFrame.Actions[648] == true )) nextActionID = 1080;
                                        if (((mainFrame.Actions[645] == true ) || (mainFrame.Actions[646] == true )) && (mainFrame.Actions[648] == false)) nextActionID = 1030;
                                        if (((mainFrame.Actions[645] == true ) || (mainFrame.Actions[646] == true )) && (mainFrame.Actions[648] == true )) nextActionID = 1100;
                                        break;
                                    default:
                                        nextActionID = 210;
                                        break;
        ...
        if (mainFrame.invCursor == true)
            {
                ...
                Borderrect tmp = mainFrame.krabat.KrabatRect();
                if ((tmp.IsPointInRect (pTemp) == true) ||
                    (rePredKorejtow.IsPointInRect (pTemp) == true) ||
                    (rePredMalickow.IsPointInRect (pTemp) == true) ||
                    (rePredWosuskow.IsPointInRect (pTemp) == true))
                    {
  	...
  	if ((nextActionID > 119) && (nextActionID < 129))
        ...
        switch (nextActionID)
            ...
            case 50:
                ...
                if (mainFrame.Actions[580] == true) nextActionID = 600;
                else nextActionID = 608;
                break;
            ...
            case 161: // warten Auf Ende Anim
                if (mainFrame.krabat.nAnimation == 0) nextActionID = 162;
                break;  
            ...
            case 164:
                ...
                if (wosIsLooking == false) nextActionID = 165;
                break;
            ...
            case 165:
                ...
                mainFrame.inventory.vInventory.removeElement (new Integer (40));
                mainFrame.inventory.vInventory.addElement    (new Integer (52));
		mainFrame.Actions[956] = true;
            ...
            case 168:
                ...
                if (wosIsGiving == false) nextActionID = 170;
                break;
		...
		if (mainFrame.krabat.nAnimation != 0) break;
                ...
                if (mainFrame.sprache == 1)
                    {
                        ...
                        // 2. Frage
                        if (mainFrame.Actions[604] == false) 
                            Dialog.ExtendMC (Start.stringManager.getTranslation("Loc3_StareWiki_00017"), 581, 1000, null, 620);
                        else Dialog.ExtendMC (Start.stringManager.getTranslation("Loc3_StareWiki_00018"), 581, 1000, null, 620);
                ...
                if (mainFrame.sprache == 2)
                    {
                        ...
                        else Dialog.ExtendMC (Start.stringManager.getTranslation("Loc3_StareWiki_00026"), 581, 1000, null, 620);
                ...
                if (mainFrame.sprache == 3)
                    {
                        ...
                        else Dialog.ExtendMC (Start.stringManager.getTranslation("Loc3_StareWiki_00034"), 581, 1000, null, 620);
            ...
            case 701:
                ...
                if ((mainFrame.Actions[585] == true) && (nextActionID == 711)) mainFrame.Actions[585] = false;        	
            ...
            case 801:
                ...
                // eine Extrawurst: Dialog 1. Frage zurueckschalten, wenn gefragt
                if ((mainFrame.Actions[590] == true) && (nextActionID == 812)) mainFrame.Actions[590] = false;        	
		...
		///// Ab hier die Gebe-Szenen mit dem Faelscher /////////////////////////////////////////////
            ...
            case 1000:
                // Dowolnosc zuerst
		if (mainFrame.Actions[592] == false) // noch kein Dialog gelaufen
		    {
			mainFrame.fPlayAnim = true;
			evalMouseMoveEvent (mainFrame.Mousepoint);
			ResetAnims();
		...
		nextActionID = 1005;
            ...
            case 1005:
                // Dowolnosc zuerst
		if ((mainFrame.krabat.nAnimation != 0) || (malIsGiving == true)) break;
                ...
                if (mainFrame.Actions[649] == false)
                    {
                        // ungesiegelte Dowolnosc
                        mainFrame.Actions[645] = true;
                        mainFrame.inventory.vInventory.removeElement (new Integer (31));
                    }		
                else
                    {
                        // gesiegelte Dowolnosc
                        mainFrame.Actions[646] = true;
                        mainFrame.inventory.vInventory.removeElement (new Integer (32));
                    }		
                break;
		...
		if ((mainFrame.krabat.nAnimation != 0) || (malIsGiving == true)) break;
                ...
                mainFrame.inventory.vInventory.removeElement (new Integer (49));
                break;
		...
		if ((mainFrame.krabat.nAnimation != 0) || (malIsGiving == true)) break;
                ...
                mainFrame.inventory.vInventory.removeElement (new Integer (45));
                break;
                ...
                if (mainFrame.Actions[649] == false)
                    {
                        ...
                        mainFrame.inventory.vInventory.addElement (new Integer (33));
                    }	
                else
                    {
                        // gesiegelte Dowolnosc hinzufuegen
                        mainFrame.inventory.vInventory.addElement (new Integer (34));
                    }	
                break;
		...
		if ((--Counter) > 1) break;
            ...
            case 1119:
                if (malIsGiving == false) nextActionID = 1120;
                break;
                ...
                switch (zuffi)
      			...
      			// der Pred korejtow ist dran
                        ...
                        switch (zuffZahl) 
                            {
                            case 0:
                                if (mainFrame.sprache == 1) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00237");
                                if (mainFrame.sprache == 2) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00238");
                                if (mainFrame.sprache == 3) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00239");
                                AnimCounter = 50;
                                break;

                            case 1:
                                if (mainFrame.sprache == 1) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00240"));
                                if (mainFrame.sprache == 2) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00241"));
                                if (mainFrame.sprache == 3) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00242"));
                                AnimCounter = 70;
                                break;

                            case 2:
                                if (mainFrame.sprache == 1) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00243"));
                                if (mainFrame.sprache == 2) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00244"));
                                if (mainFrame.sprache == 3) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00245"));
                                AnimCounter = 100;
                                break;

                            case 3:
                                if (mainFrame.sprache == 1) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00246"));
                                if (mainFrame.sprache == 2) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00247"));
                                if (mainFrame.sprache == 3) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00248"));
                                AnimCounter = 120;
                                break;
                            }
                    ...
                    case 2:
                        ...
                        switch (zuffZahl2) 
                            {
                            case 0:
                                if (mainFrame.sprache == 1) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00249");
                                if (mainFrame.sprache == 2) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00250");
                                if (mainFrame.sprache == 3) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00251");
                                AnimCounter = 70;
                                break;

                            case 1:
                                if (mainFrame.sprache == 1) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00252"));
                                if (mainFrame.sprache == 2) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00253"));
                                if (mainFrame.sprache == 3) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00254"));
                                AnimCounter = 100;
                                break;

                            case 2:
                                if (mainFrame.sprache == 1) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00255");
                                if (mainFrame.sprache == 2) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00256");
                                if (mainFrame.sprache == 3) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00257");
                                AnimCounter = 50;
                                break;
                            }
        		...
        		break;
                    ...
                    case 3:
                        ...
                        switch (zuffZahl3) 
                            {
                            case 0:
                                if (mainFrame.sprache == 1) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00258"));
                                if (mainFrame.sprache == 2) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00259"));
                                if (mainFrame.sprache == 3) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00260"));
                                AnimCounter = 60;
                                break;

                            case 1:
                                if (mainFrame.sprache == 1) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00261");
                                if (mainFrame.sprache == 2) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00262");
                                if (mainFrame.sprache == 3) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00263");
                                AnimCounter = 50;
                                break;

                            case 2:
                                if (mainFrame.sprache == 1) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00264");
                                if (mainFrame.sprache == 2) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00265");
                                if (mainFrame.sprache == 3) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00266");
                                AnimCounter = 60;
                                break;

                            case 3:
                                if (mainFrame.sprache == 1) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00267");
                                if (mainFrame.sprache == 2) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00268");
                                if (mainFrame.sprache == 3) AnimOutputText = Start.stringManager.getTranslation("Loc3_StareWiki_00269");
                                AnimCounter = 60;
                                break;

                            case 4:
                                if (mainFrame.sprache == 1) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00270"));
                                if (mainFrame.sprache == 2) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00271"));
                                if (mainFrame.sprache == 3) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc3_StareWiki_00272"));
                                AnimCounter = 70;
                                break;
                            }
