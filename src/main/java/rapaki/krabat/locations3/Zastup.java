...
import rapaki.krabat.anims.Mato;
...
public class Zastup extends Mainloc 
{
    ...
    private void InitBorders ()
    {
        ...
        if (mainFrame.Actions[575] == true) SchrankCount = 11;
        else SchrankCount = 1;  
    }
...
//             }  
	...
	if (mainFrame.Actions[575] == false) evalSound (); // Hier zufaellige Soundausgabe
    ...
    private void DoAction ()
    {
  	...
  	if ((nextActionID > 119) && (nextActionID < 129))
		...
		// Flag setzen, dass Kr. raus war -> Mato in Zastup weg, aber nur, wenn Pelz gegeben
                if (mainFrame.Actions[575] == true) mainFrame.Actions[576] = true;
                break;
		...
		if ((--Verhinderschranke) < 1)
			...
			SchrankCount++;
                ...
                if (SchrankCount == 11) nextActionID = 350;
                break;
