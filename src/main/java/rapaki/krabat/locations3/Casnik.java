...
import rapaki.krabat.anims.HlownyStraznik;
...
public class Casnik extends Mainloc 
{
	...
	if (mainFrame.Actions[608] == false)
        ...
        if (trink == true) trink = false;
        if (schlafein == true) schlafein = false;    
        ...
        // Anims bedienen
        if (straznikSchnarcht == true) DoAnims();
	...
	if (noSoundActive == true) return;

	if ((--SoundCountdown) > 1) return; // wenn noetig, dann bisschen warten, ehe was gespielt wird

	// nur kurz vor Ausschlagende abspielen
	if ((Pendelpos == 2) && (tick == true))  mainFrame.wave.PlayFile ("sfx-dd/tick.wav");
	if ((Pendelpos == 0) && (tick == false)) mainFrame.wave.PlayFile ("sfx-dd/tack.wav");
    }    
  	...
  	if ((nextActionID > 119) && (nextActionID < 129))
        ...
        switch (nextActionID)
	    		...
	    		if ((mainFrame.Actions[615] == false) || (mainFrame.Actions[616] == false) || (mainFrame.Actions[617] == false)) 
                            {
                                ...
                                evalMouseMoveEvent (mainFrame.Mousepoint);
                                nextActionID = 301;
                                if (mainFrame.Actions[616] == true)  mainFrame.Actions[617] = true;
                                if (mainFrame.Actions[615] == true)  mainFrame.Actions[616] = true;
                                if (mainFrame.Actions[615] == false) mainFrame.Actions[615] = true;
                            }
	    		else 
                            {
            ...
            case 50:
                ...
                if (mainFrame.Actions[601] == true) nextActionID = 600;
                ...
                else 
                    {
                        ...
                        if ((mainFrame.Actions[618] == false) || (mainFrame.Actions[619] == false) || (mainFrame.Actions[620] == false)) 
                            {		
                                ...
                                evalMouseMoveEvent (mainFrame.Mousepoint);
                                nextActionID = 300;
                                if (mainFrame.Actions[619] == true)  mainFrame.Actions[620] = true;
                                if (mainFrame.Actions[618] == true)  mainFrame.Actions[619] = true;
                                if (mainFrame.Actions[618] == false) mainFrame.Actions[618] = true;
                            }
	    		else 
                            {
                                // zur Strafe in die Kueche zurueck
		...
		if (readyFlag == true) break;
            ...
            case 240:
                ...
                if (readyFlag == false) nextActionID = 245;
                break;
		...
		noSoundActive = false;
            ...
            case 300:
                ...
                switch (zuffZahl) {
                case 0:
                    if (mainFrame.sprache == 1) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00066");
                    if (mainFrame.sprache == 2) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00067");
                    if (mainFrame.sprache == 3) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00068");
                    break;

                case 1:
                    if (mainFrame.sprache == 1) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00069");
                    if (mainFrame.sprache == 2) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00070");
                    if (mainFrame.sprache == 3) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00071");
                    break;

                case 2:
                    if (mainFrame.sprache == 1) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00072");
                    if (mainFrame.sprache == 2) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00073");
                    if (mainFrame.sprache == 3) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00074");
                    break;
                }
            ...
            case 301:
                ...
                switch (zuffZahl2) {
                case 0:
                    if (mainFrame.sprache == 1) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00075");
                    if (mainFrame.sprache == 2) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00076");
                    if (mainFrame.sprache == 3) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00077");
                    break;

                case 1:
                    if (mainFrame.sprache == 1) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00078");
                    if (mainFrame.sprache == 2) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00079");
                    if (mainFrame.sprache == 3) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00080");
                    break;

                case 2:
                    if (mainFrame.sprache == 1) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00081");
                    if (mainFrame.sprache == 2) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00082");
                    if (mainFrame.sprache == 3) outputText = Start.stringManager.getTranslation("Loc3_Casnik_00083");
                    break;
                }
