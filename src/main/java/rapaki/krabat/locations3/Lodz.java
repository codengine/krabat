...
import rapaki.krabat.anims.WikowarkaRudy;
...
public class Lodz extends Mainloc 
{
    ...
    public Lodz (Start caller,int oldLocation) 
    {
        ...
        if (mainFrame.Actions[559] == true) zonaVisible = false;  // nachdem Anim gelaufen, ist sie nicht mehr da
                        ...
                        if ((Stollen == true) || (Metall == true) || (Kiss == true))
                            {
                                ...
                                if (Stollen == true) wikowarka.giveWosusk (g, tp.lo_point);
                                if (Metall  == true) wikowarka.giveMetal  (g, tp.lo_point);
                                if (Kiss    == true) wikowarka.Kiss       (g, new GenericPoint (tp.lo_point.x, (tp.lo_point.y + 21)));
                            }
                        else wikowarka.drawZona (g, isListening);
                    } 
  	...
  	if ((nextActionID > 119) && (nextActionID < 129))
		...
		break;
            ...
            case 182:
                ...
                if (walkReady == true) nextActionID = 183;
                break;
		...
		isListening = false;
                if (walkReady == true) nextActionID = 310;
                break;
