...
import rapaki.krabat.anims.StrazaPoklad;
...
public class Poklad extends Mainloc 
{
  ...
  public void paintLocation (GenericDrawingContext g)
  {
    ...
    if (whatPicture == 1) g.drawImage (schody, 0, 0, null);
    if (whatPicture == 2) g.drawImage (komora, 0, 0, null);
    ...
    if (showDingl == true)
    {
      ...
      if (whatPicture == 1) g.drawImage (vorderschody, 147, 0, null);
    }  
