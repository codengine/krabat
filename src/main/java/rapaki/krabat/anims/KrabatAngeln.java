...
public class KrabatAngeln extends Mainanim
{
	...
	if ((--Verhinderangeln) < 1)
	    {	
	    	...
	    	if (Zwinkern == 1) Zwinkern = 0;
	    	else
		    {
			int zuffi = (int) (Math.random () * 50);
			if (zuffi > 45) Zwinkern = 1;
		    }
	...
	// alles Zeichnen
    	...
    	else g.drawImage (angle_rechts[0], leftUp.x, leftUp.y, null);
	...
	// alles Zeichnen
    	...
    	else g.drawImage (angle_links[0], leftUp.x, leftUp.y, null);
	...
	if ((fangen == 10) && (Verhinderangeln == MAX_VERHINDERANGELN))
	    mainFrame.wave.PlayFile ("sfx/woda2.wav");	  ////////////////////////////////// Sound !!!!!!!!!!!!!!!!!!  
	...
	if ((fangen == MAXFANGEN) && (Verhinderangeln == MAX_VERHINDERANGELN))
	    mainFrame.wave.PlayFile ("sfx/woda1.wav");	  ////////////////////////////////// Sound !!!!!!!!!!!!!!!!!!  
	if ((fangen == 10) && (Verhinderangeln == MAX_VERHINDERANGELN))
	    mainFrame.wave.PlayFile ("sfx/woda2.wav");	  ////////////////////////////////// Sound !!!!!!!!!!!!!!!!!!  
	...
	if ((TalkPerson != 1) && (TalkPerson != 3)) Head = 0;
