...
public class HlownyStraznik extends Mainanim
{
	...
	if ((sit == true) || (isSleeping == true))
	    {
		// Hinsetzimages
		if (Sit == 0) return (new Borderrect (casnikPoint1.x, casnikPoint1.y,
						      casnikPoint1.x + straz_sit[Sit].getWidth(null),
						      casnikPoint1.y + straz_sit[Sit].getHeight(null)));
		else          return (new Borderrect (casnikPoint2.x, casnikPoint2.y,
    ...
    {
    	// Variablen setzen
    	if (trink == true) drink = true;
    	if (schlafein == true) sit = true;
	...
	if (istCasnik == true)
		...
		if ((sit == true) || (isSleeping == true))
		    {
			if (Sit == 0) offGraph.drawImage (straz_sit[Sit], casnikPoint1.x, casnikPoint1.y, null);
			else          offGraph.drawImage (straz_sit[Sit], casnikPoint2.x, casnikPoint2.y, null);
			offGraph.drawImage (vorder, 121, 308, null);
			return;
		    }
	...
	else return (new GenericPoint (casnikPoint1.x + 21, casnikPoint2.y - 50)); // hier steht er
    }
}    