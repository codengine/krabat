...
public class Rapak extends Mainanim
{
    ...
    {
	if (flyfront == false) return (sideptack.ptack2Rect ());
	...
	if ((TalkPerson == 41) && (mainFrame.talkCount > 1))
		...
		switch (whichanim)		
		    ...
		    case 1:
    	  		// Zwinkern
    	  		if (Animcount == 0) offGraph.drawImage (Vogel[2], 412, 144, null);
    	  		if (Animcount == 1) offGraph.drawImage (Vogel[2], 412, 144, null);
    	  		Animcount++;
    	  		if (Animcount == 2)
			    {
    	  			Animcount = 0;
		    ...
		    case 2:
    	  		...
    	  		if (Animcount == 0) offGraph.drawImage (Vogel[3], 412, 144, null);
    	  		if (Animcount == 1) offGraph.drawImage (Vogel[3], 412, 144, null);
    	  		if (Animcount == 2) offGraph.drawImage (Vogel[1], 412, 144, null);
    	  		if (Animcount == 3) offGraph.drawImage (Vogel[1], 412, 144, null);
    	  		if (Animcount == 4) offGraph.drawImage (Vogel[3], 412, 144, null);
    	  		if (Animcount == 5) offGraph.drawImage (Vogel[3], 412, 144, null);
    	  		Animcount++;
    	  		if (Animcount == 6)
			    {
    	  			Animcount = 0;
		    ...
		    case 3:
    	  		...
    	  		if (Animcount == 0) offGraph.drawImage (Vogel[4], 412, 144, null);
    	  		if (Animcount == 1) offGraph.drawImage (Vogel[4], 412, 144, null);
    	  		if (Animcount == 2) offGraph.drawImage (Vogel[1], 412, 144, null);
    	  		if (Animcount == 3) offGraph.drawImage (Vogel[1], 412, 144, null);
    	  		if (Animcount == 4) offGraph.drawImage (Vogel[4], 412, 144, null);
    	  		if (Animcount == 5) offGraph.drawImage (Vogel[4], 412, 144, null);
    	  		Animcount++;
    	  		if (Animcount == 6)
			    {
    	  			Animcount = 0;
    ...
    public boolean fliegRapak (GenericDrawingContext offGraph)
    {
  	...
  	if (fliegehoch == true)
		...
		// Rabe erhebt sich
		Fliegpos++;
		if (Fliegpos == 4) Fliegpos = 0;
  	
		Fliegcount++;
		if (Fliegcount == 15) fliegehoch = false;
