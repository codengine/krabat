    ...
    public void drawMichal (GenericDrawingContext offGraph, int TalkPerson, GenericPoint pos, boolean isListening)
    {
    	...
    	else
    	{
    	  ...
    	  if ((--Verhinderwork) < 1)
    	  {
		    ...
		    if ((mainFrame.inventory.noBackgroundSound == false) || (mainFrame.invCursor == false)) mainFrame.wave.PlayFile ("sfx/nepl.wav");
    	    	  Work = 5;
    	    	  break;
