...
import rapaki.krabat.anims.BurHanza;
import rapaki.krabat.anims.BurMichal;
...
public class Polo1 extends Mainloc 
{
	...
	if (mainFrame.Actions[912] == true) 
	    ...
	    {
		g.setClip (180, 339, 102, 35);
		if (stein1verdeckt == true) g.drawImage (polo3, 180, 339, null);
		if (stein2verdeckt == true) g.drawImage (polo4, 211, 339, null);
		if (stein3verdeckt == true) g.drawImage (polo5, 231, 339, null);
	    }
