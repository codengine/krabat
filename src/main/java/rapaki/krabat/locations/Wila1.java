...
import rapaki.krabat.anims.Plokarka;
...
public class Wila1 extends Mainloc 
{
    ...
    public Wila1 (Start caller,int oldLocation) 
    {
  	...
  	mainFrame.krabat.maxx = 463;
        ...
        if (mainFrame.Actions[175] == false) waescheFehlt = 0;
                        ...
                        if (mainFrame.Actions[175] == false)
                            {
                                ...
                                switch (waescheFehlt)
                                    ...
                                    default: 
					System.out.println ("Fehler im LeineChooser !");
                                        break;
                                    }		
                            }
                        else
        ...
        if (showPlokarka == true)	
            {
                ...
                if (((TalkPerson == 27) || (TalkPerson == 55)) && (mainFrame.talkCount > 0))
                    {
                        if (TalkPerson == 27) waschfrau.talkPlokarka (g);	
                        if (TalkPerson == 55) waschfrau.haendePlokarka (g);
                    }
                        ...
                        if (isAbnehming == true)
                            {
                                ...
                                if (isAbnehming == false) waescheFehlt++;
                            }
                        else
                            {
                ...
                if (SonderAnim == 1) 
                    {
                        ...
                        if (((++AnimCounter) % 4) == 0)
                            {
                                if (AnimPosition == 1) AnimPosition = 0;
                                else AnimPosition = 1;
                            }
  	...
  	if ((nextActionID > 119) && (nextActionID < 129))
		...
		mainFrame.wave.PlayFile ("sfx/vdurjeauf.wav");
            ...
            case 58:
                ...
                if (walkReady == true) nextActionID = 60;
                break;
            ...
            case 62:
                // Warten, bis sie ausgelaufen ist
                if (walkReady == true) nextActionID = 65;
                break;
		...
		mainFrame.krabat.SetFacing (6);
                if (mainFrame.Actions[176] == false)
                    {
                        if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Wila1_00012")); 
                        if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Wila1_00013")); 
                        if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Wila1_00014"));
                        mainFrame.Actions[176] = true;
                    }
                else
                    {
                        if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Wila1_00015")); 
                        if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Wila1_00016")); 
                        if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Wila1_00017"));
                    }				
            ...
            case 72:
                // Warten, bis sie ausgelaufen ist
                if (walkReady == true) nextActionID = 75;
                break;
            ...
            case 78:
                // Warten, bis sie ausgelaufen ist
                if (walkReady == true) nextActionID = 80;
                break;
		...
		mainFrame.wave.PlayFile ("sfx/vdurjezu.wav");
			...
			mainFrame.wave.PlayFile ("sfx/bloto2.wav");
                ...
                if ((mainFrame.krabat.nAnimation != 0) || (SonderAnim != 0)) break;
		...
		mainFrame.wave.PlayFile ("sfx/vdurjeauf.wav");
            ...
            case 185:
                // Warten, bis sie ausgelaufen ist
                if (walkReady == true) nextActionID = 186;
                break;
            ...
            case 187:
                // Warten, bis sie ausgelaufen ist
                if (walkReady == true) nextActionID = 190;
                break;

            case 190:
                // Sie sagt ihren Spruch
                if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Wila1_00021")); 
                if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Wila1_00022")); 
                if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Wila1_00023"));
                // Hier Position des Textes berechnen
            ...
            case 192:
                // Warten, bis sie ausgelaufen ist
                if (walkReady == true) nextActionID = 193;
                break;
            ...
            case 194:
                ...
                if (isAbnehming == false) nextActionID = 195;
                break;
            ...
            case 196:
                // Warten, bis sie ausgelaufen ist
                if (walkReady == true) nextActionID = 197;
                break;
            ...
            case 198:
                // warten auf Ende abnehmen
                if (isAbnehming == false) nextActionID = 199;
                break;
            ...
            case 200:
                // Warten, bis sie ausgelaufen ist
                if (walkReady == true) nextActionID = 201;
                break;
            ...
            case 202:
                // warten auf Ende abnehmen
                if (isAbnehming == false) nextActionID = 203;
                break;
            ...
            case 204:
                // Warten, bis sie ausgelaufen ist
                if (walkReady == true) nextActionID = 205;
                break;
            ...
            case 215:
                // Warten, bis sie ausgelaufen ist
                if (walkReady == true) nextActionID = 220;
                break;
            ...
            case 225:
                // Warten, bis sie ausgelaufen ist
                if (walkReady == true) nextActionID = 226;
                break;
            ...
            case 227:
                // Warten, bis sie ausgelaufen ist
                if (walkReady == true) nextActionID = 230;
                break;
