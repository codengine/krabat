...
public class Labyr2 extends Mainlaby 
{
  ...
  private static final GenericPoint Aoben   = new GenericPoint (301, 199);
  private static final GenericPoint Alinks  = new GenericPoint ( 10, 275);
  private static final GenericPoint Arechts = new GenericPoint (610, 296);
  ...
  private static final int[] Exitleft  = {51, 53, 55, 57/*,58*/, 59, 60, 62};
  private static final int[] Exitup    = {53, 54, 56, 59, 60, /*62*/};
 
  // Konstante Points
  private static final GenericPoint Pleft    = new GenericPoint (  0, 364);
  private static final GenericPoint Pright   = new GenericPoint (639, 369);
  private static final GenericPoint Pup      = new GenericPoint (298, 275);
  
  // Nach diesem Fusspunkt richtet sich die komplette Location !!!
  private static final GenericPoint bludFeet = new GenericPoint (524, 339);

  // Initialisierung ////////////////////////////////////////////////////////

  // Instanz von dieser Location erzeugen
  public Labyr2 (Start caller,int Richtung) 
  {
    super (caller);
    System.out.println ("Laby 2");
  ...
  private void InitLocation (int Richtung)
  {
    ...
    mainFrame.wegGeher.vBorders.addElement (new Bordertrapez (259, 292, 231, 308, 306, 345));
    mainFrame.wegGeher.vBorders.addElement (new Bordertrapez (281, 310, 259, 292, 274, 305));
    ...
    switch (Richtung)
    {
      case 0: 
        // Einsprung fuer Load
        // alle Moeglichkeiten zulassen bei Load, merkt eh keiner...
        BackgroundMusicPlayer.getInstance ().playTrack (10, true);
        Ausgang = BerechneAusgang (true, false, false, true);
        break;
    	case 3:
        // von links aus
    		mainFrame.krabat.SetKrabatPos (new GenericPoint ( 26, 370));
        mainFrame.krabat.SetFacing (3);
        Ausgang = BerechneAusgang (true, false, false, true);
        break;
      case 9: 
        // von rechts aus
        mainFrame.krabat.SetKrabatPos (new GenericPoint (606, 378));
        mainFrame.krabat.SetFacing (9);
        Ausgang = BerechneAusgang (true, false, false, false);
        break;
      case 6: 
        // von oben aus
        mainFrame.krabat.SetKrabatPos (new GenericPoint (289, 288));
  ...
  {
    background = getPicture ("gfx/labyrinth/laby2.gif");
    lab22      = getPicture ("gfx/labyrinth/lab2-2.gif");
  ...
  public void paintLocation (GenericDrawingContext g)
  {
    ...
    if (lab22Rect.IsPointInRect (pKrTemp) == true)
    {
      g.drawImage (lab22, 563, 366, null);
    }
