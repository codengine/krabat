...
public class Haty1 extends Mainloc 
{
    ...
    public void paintLocation (GenericDrawingContext g)
    {
        ...
        if (clipIstLinks == true) g.setClip (200, 80, 100, 100);
        else                      g.setClip (460, 80, 100, 100);
        g.drawImage (background, 0, 0, null);
	...
	if (whichMuell > -1)
        ...
        else angler2.drawWudzer2 (g, stehenderAnglerSchautSichUm);
        ...
        if (Sonderstatus != 0)
            {
                ...
                if (nochaktiv == false) Sonderstatus = 0;	    
            }
        else
            {		  		
                // Animation??
                            ...
                            ((angler1.Wudzer1Rect().IsPointInRect (pTemp) == false) && (angler2.Wudzer2Rect().IsPointInRect (pTemp) == false)))
                            {
                                switch (mainFrame.whatItem)
                                    ...
                                    case 9: // wuda + hocka
                                        ...
                                        break;
                                    case 10: // wuda + wacka
                                        if (mainFrame.Actions[220] == false) nextActionID = 1240;
                                        else nextActionID = 1200;
                                        break;
                                    case 11: // wuda + dryba  
                                        if (mainFrame.Actions[220] == false) nextActionID = 200;
                                        else nextActionID = 1200;
                                        break;
                                    case 14: // ryba
                                        nextActionID = 390;
                            ...
                            ((angler1.Wudzer1Rect().IsPointInRect (pTemp) == false) && (angler2.Wudzer2Rect().IsPointInRect (pTemp) == false)))
                            {
                                switch (mainFrame.whatItem)
                                    ...
                                    case 9: // wuda + hocka
                                        ...
                                        break;
                                    case 10: // wuda + wacka
                                        if (mainFrame.Actions[220] == false) nextActionID = 1210;
                                        else
                                            {
                                                ...
                                                else nextActionID = 1230;		
                                            }		 
                                        break;
                                    case 11: // wuda + dryba  
                                        if (mainFrame.Actions[220] == false) nextActionID = 1210;
                                        else nextActionID = 1250;
                                        break;
                                    case 14: // ryba
                                        nextActionID = 395;
                                        break;
                        ...
                        if ((angler1.Wudzer1Rect().IsPointInRect (pTemp) == true) || (angler2.Wudzer2Rect().IsPointInRect (pTemp) == true))
                            {
                                ...
                                if (mainFrame.Actions[220] == false) pTemp = PwudzerRight;
                                else pTemp = PwudzerLeft;
                            }			              		        
                                ...
                                if ((MerkArray[i][j][0] != 0) && (MerkArray[i][j][1] != 0))
                                    {	
                                        ...
                                        switch (MerkArray[i][j][2])
                                            ...
                                            default: System.out.println ("Fehler in Blinkerroutine !!!");
    ...
    private void DoAction ()
    {
  	...
  	if ((nextActionID > 119) && (nextActionID < 129))
		...
		break;
            ...
            case 60:
                ...
                switch (zuffZahl)
                    {
                    case 0:
        		if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00051"));
		        if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00052"));        
                        if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00053"));
                        break;
    		    
                    case 1:
        		if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00054"));
		        if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00055"));        
                        if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00056"));
                        break;
    		    
                    case 2:
        		if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00057"));
		        if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00058"));        
                        if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00059"));
                        break;
                    }    
                outputTextPos = mainFrame.ifont.CenterText (outputText, angler2.Wudzer2TalkPoint());
                if (mainFrame.Actions[220] == false) mainFrame.krabat.SetFacing (3);
                else mainFrame.krabat.SetFacing (9);
                TalkPerson = 31;
                nextActionID = 0;
                break;
            ...
            case 65:
                ...
                switch (zuffZahl2)
                    {
                    case 0:
        		if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00060"));
		        if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00061"));
                        if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00062"));
                        break;
    		    
                    case 1:
        		if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00063"));
		        if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00064"));        
                        if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00065"));
                        break;
                    }    
                outputTextPos = mainFrame.ifont.CenterText (outputText, angler2.Wudzer2TalkPoint());
                if (mainFrame.Actions[220] == false) mainFrame.krabat.SetFacing (3);
            ...
            case 80:
                ...
                switch (zuffZahl3)
                    {
                    case 0:
        		if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00072"));
		        if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00073"));
                        if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00074"));
                        break;
    		    
                    case 1:
        		if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00075"));
		        if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00076"));   
                        if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Haty1_00077"));
                        break;
                    }    
                outputTextPos = mainFrame.ifont.CenterText (outputText, angler2.Wudzer2TalkPoint());
		...
		stehenderAnglerSchautSichUm = true;
                if (mainFrame.Actions[156] == false) nextActionID = 600;  // erstes Ansprechen
		else nextActionID = 610;
                break;
		...
		break;
            ...
            case 160:
                // Bow - Ausreden
                if (mainFrame.Actions[220] == false) DingAusrede (fBowRight);
                else DingAusrede (fBowLeft);
                break;
            ...
            case 180:
                // Angler - Ausreden
                if (mainFrame.Actions[220] == false) MPersonAusrede (fWudzerjoRight);
                else MPersonAusrede (fWudzerjoLeft);
                break;
		...
		stehenderAnglerSchautSichUm = false;
            ...
            case 228:
                ...
                if ((walkWudzer1 == false) || (walkWudzer2 == false)) break;
                InitAngler ();
                mainFrame.Clipset = false;
                TalkPause = 5;
                nextActionID = 229;
		...
		schnauzeFische = true;
            ...
            case 1222:
                ...
                if (Sonderstatus == 0) nextActionID = 1224;
                break;
		...
		schnauzeFische = true;
            ...
            case 1232: 
                ...
                if (Sonderstatus == 0) nextActionID = 1238;
                break;	
		...
		schnauzeFische = true;
            ...
            case 1242: 
                // warten auf Ende Anim
                if (Sonderstatus == 0) nextActionID = 1248;
                break;	
