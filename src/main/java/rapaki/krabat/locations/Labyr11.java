...
public class Labyr11 extends Mainlaby 
{
  private GenericImage background, lab112, lab113, lab114; 
  ...
  private void InitLocation (int Richtung)
  {
    ...
    mainFrame.wegGeher.vBorders.addElement (new Bordertrapez (  0, 381, 225, 417));
    mainFrame.wegGeher.vBorders.addElement (new Bordertrapez (226, 365, 357, 414));
    mainFrame.wegGeher.vBorders.addElement (new Bordertrapez (367, 385, 323, 357, 318, 364));
    mainFrame.wegGeher.vBorders.addElement (new Bordertrapez (361, 383, 367, 385, 301, 317));
    ...
    switch (Richtung)
    {
      case 0: 
        ...
        Ausgang = BerechneAusgang (true, false, true, false);
        break;
    	case 6:
        // von oben aus
    		mainFrame.krabat.SetKrabatPos (new GenericPoint (360, 340));
        mainFrame.krabat.SetFacing (6);
        Ausgang = BerechneAusgang (false, false, true, false);
        break;
      case 3: 
        // von links aus
        mainFrame.krabat.SetKrabatPos (new GenericPoint ( 45, 403));
  ...
  {
    background = getPicture ("gfx/labyrinth/laby11.gif");
    lab112     = getPicture ("gfx/labyrinth/lab11-2.gif");
    lab113     = getPicture ("gfx/labyrinth/lab11-3.gif");
    lab114     = getPicture ("gfx/labyrinth/lab11-4.gif");
