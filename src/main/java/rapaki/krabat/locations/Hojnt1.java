...
public class Hojnt1 extends Mainloc
{
  ...
  public Hojnt1 (Start caller, int oldLocation)
  {
    ...
    switch (oldLocation)
    {
      ...
      case 29: // aus der Animszene Hojnth
        ...
        setAnim = true;
        setScroll = true;
        if (mainFrame.Actions[216] == true) AnimFlag = 30;
        else AnimFlag = 20;
        break;
    }    
  ...
  public void paintLocation (GenericDrawingContext g)
  {
    ...
    if (mainFrame.krabat.fAnimHelper == true)
    {
      if (WhichItem == 5)
      {
      	mainFrame.inventory.vInventory.addElement (new Integer (5));
    ...
    if (showHojnt == true)	
    {
      ...
      if (istJaegerGebueckt == false) g.setClip (temp.lo_point.x - 10, temp.lo_point.y - 10,
                                                 temp.ru_point.x - temp.lo_point.x + 20,
                                                 temp.ru_point.y - temp.lo_point.y + 20);
      
      // groesseres Cliprect weg wegen Buecken
      else g.setClip (temp.lo_point.x - 10, temp.lo_point.y - 10,
    ...
    if ((mainFrame.Actions[231] == false) && (mainFrame.Actions[232] == false))
    {
      ...
      {	
	      ...
	      {
	      	xpos += MOVE;
	      	if (xpos > MAX_SCHATTENX) isLeft = true;
	      }
	      else
	      {
	      	xpos -= MOVE;
	      	if (xpos < MIN_SCHATTENX) isLeft = false;
	      }				
      }
      g.setClip (340, 246, 273, 83);
      g.drawImage (backl, 0, 0, null);
      if (isLeft == true) g.drawImage (leftschatten, xpos, 280, null);
      else g.drawImage (rightschatten, xpos, 280, null);
      g.drawImage ((mainFrame.Actions[905] == false) ? vorder2 : vorder, 340, 246, null);
    }	
    ...
    if (showHojnt == true)	
    {
      ...
      {
      	// normal zeichnen
      	if (istJaegerGebueckt == false) jaeger.drawHojnt (g);
      	
      	// Bueckphase zeichnen (schaltet sich selbst ab)
      	else istJaegerGebueckt = jaeger.bueckeHojnt (g);
      }	 		
    }		
    ...
    if (setAnim == true)
    {
    	...
    	if (AnimFlag == 10)	nextActionID = 200;
    	if (AnimFlag == 20) nextActionID = 300;
    	if (AnimFlag == 30) nextActionID = 400;
    	if (AnimFlag == 40) nextActionID = 350;
    }		
  ...
  public void evalMouseEvent (GenericMouseEvent e)
  {
    ...
    if (mainFrame.invCursor == true)
    {
	  ...
	  nextActionID = 0;
        ...
        // Ausreden fuer Haken
        if ((hakenRect.IsPointInRect (pTemp) == true) && (mainFrame.Actions[905] == false))
        {
        ...
        if (leineRect.IsPointInRect (pTemp) == true)
        {
          ...
          else
          {
            switch (mainFrame.whatItem)
            {
            	...
            	case 10: // wuda + wacka
            	case 11: // wuda + dryba
	              if (mainFrame.Actions[905] == false)
	              {	
        ...
        if ((mainFrame.Actions[231] == true) && (brMega.IsPointInRect (pTemp) == true))
        {
          nextActionID = 320;
          pTemp = Pmega;
        }
    ...
    else
    {
      ...
      else
      {
        ...
        // Haken mitnehmen ?
        if ((hakenRect.IsPointInRect (pTemp) == true) &&
        (mainFrame.Actions[905] == false))
        {
          nextActionID = 50;
  ...
  public void evalMouseMoveEvent (GenericPoint pTxxx)
  {
    ...
    if (mainFrame.invCursor == true)
    {
      // hier kommt Routine hin, die Highlight berechnet
    	Borderrect tmp = mainFrame.krabat.KrabatRect();
    	if ((tmp.IsPointInRect (pTemp) == true) ||
    	   ((hakenRect.IsPointInRect (pTemp) == true) && (mainFrame.Actions[905] == false)) ||
  ...
  private void DoAction ()
  {
    ...
    switch (nextActionID)
    {
      ...
      case 6:
        // Wokno anschauen
        if (mainFrame.Actions[231] == false)
        {
	...
	mainFrame.wave.PlayFile ("sfx/pasle1.wav");
      ...
      case 162:
      	// warten Ende anim
      	if (mainFrame.krabat.fAnimHelper == true) nextActionID = 163;
      	break;
      ...
      case 171:
      	...
      	if (klingeln == false) nextActionID = 175;
      	break;
      ...
      case 182:
      	...
      	if (mainFrame.krabat.nAnimation == 0) nextActionID = 185;
      	break;  
      ...
      case 220:
      	...
      	if (walkReady == true) nextActionID = 225;
      	break;
      ...
      case 227:
      	...
      	if (istJaegerGebueckt == true) break;
	...
	mainFrame.Actions[230] = false;
      ...
      case 235:
      	// Warten, bis er ausgelaufen ist
      	if (walkReady == true) nextActionID = 240;
      	break;
      ...
      case 245:
      	// Warten, bis er ausgelaufen ist
      	if (walkReady == true) nextActionID = 250;
      	break;
