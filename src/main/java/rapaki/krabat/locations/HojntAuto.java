...
import rapaki.krabat.anims.Hojnt;
...
{
    private GenericImage backl, backr, skyl, skyr, /*hojnt2, */ hojnt3, /* hojnt4, seil, baum, */ hoelzerback, offeneTuer; 
 ...
 // private static final borderrect leineRect      = new borderrect (1100, 245, 1155, 362);
	...
	switch (nextActionID)
		...
		if (klingeln == false) nextActionID = 150;
		break;
		...
		if (walkReady == true) nextActionID = 159;
		break;
      	
	    case 159:
		// Jaeger sagt Spruch vor dem Loslaufen
		if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_HojntAuto_00000")); 
		if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_HojntAuto_00001")); 
		if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_HojntAuto_00002"));
	    ...
	    case 170:
		// Warten, bis er ausgelaufen ist
		if (walkReady == true) nextActionID = 173;
		break;
	    ...
	    case 176:
		// Warten, bis er ausgelaufen ist
		if (walkReady == true) nextActionID = 180;
		break;
	    ...
	    case 510:
		// Warten, bis er ausgelaufen ist
		if (walkReady == true) nextActionID = 513;
		break;
	    ...
	    case 516:
		// Warten, bis er ausgelaufen ist
		if (walkReady == true) nextActionID = 520;
		break;
      	
	    case 520:
		// Jaeger sagt Spruch vor dem Ende
		if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_HojntAuto_00003")); 
		if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_HojntAuto_00004")); 
		if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_HojntAuto_00005"));
		// Hier Position des Textes berechnen
		Borderrect temp = jaeger.HojntRect ();
	    ...
	    case 533:
		// Warten, bis er ausgelaufen ist
		if (walkReady == true) nextActionID = 536;
		break;
	    ...
	    case 610:
		// Warten auf Ende Klingeln
		if (klingeln == false) nextActionID = 620;
		break;
	    ...
	    case 625:
		// Warten, bis er ausgelaufen ist
		if (walkReady == true) nextActionID = 650;
		break;
      	
	    case 650:
		// Jaeger sagt Spruch, wenn Krabat reingefallen ist
		if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_HojntAuto_00006")); 
		if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_HojntAuto_00007")); 
		if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_HojntAuto_00008"));
		// Hier Position des Textes berechnen
