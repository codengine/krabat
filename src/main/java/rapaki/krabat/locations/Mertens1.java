...
import rapaki.krabat.anims.WodnyMuz;
...
public class Mertens1 extends Mainloc 
{
    ...
    public void paintLocation (GenericDrawingContext g)
    {
        ...
        if ((Counter > 0) && (mainFrame.Actions[206] == false))
            {
                Counter--;
                if (Counter < 1)
                    {
  	...
  	if ((nextActionID > 119) && (nextActionID < 129))
        ...
        switch (nextActionID)
            ...
            case 50:
                ...
                if (mainFrame.Actions[160] == false)
                    {
                        nextActionID = 600;
                    }
                else
            ...
            case 600:
                ...
                if (mainFrame.sprache == 1)
     			...
     			Dialog.ExtendMC (Start.stringManager.getTranslation("Loc1_Mertens1_00013"), 164, 165, new int[] {165}, 650);
                        ...
                        if (mainFrame.Actions[168] == false) Dialog.ExtendMC (Start.stringManager.getTranslation("Loc1_Mertens1_00015"), 166, 167, new int[] {167}, 670);
                        else                      					 Dialog.ExtendMC (Start.stringManager.getTranslation("Loc1_Mertens1_00016"), 166, 167, new int[] {167}, 670);
                ...
                if (mainFrame.sprache == 2)
     			...
     			Dialog.ExtendMC (Start.stringManager.getTranslation("Loc1_Mertens1_00024"), 164, 165, new int[] {165}, 650);
                        ...
                        if (mainFrame.Actions[168] == false) Dialog.ExtendMC (Start.stringManager.getTranslation("Loc1_Mertens1_00026"), 166, 167, new int[] {167}, 670);
                        else                      					 Dialog.ExtendMC (Start.stringManager.getTranslation("Loc1_Mertens1_00027"), 166, 167, new int[] {167}, 670);
                ...
                if (mainFrame.sprache == 3)
     			...
     			Dialog.ExtendMC (Start.stringManager.getTranslation("Loc1_Mertens1_00035"), 164, 165, new int[] {165}, 650);
                        ...
                        if (mainFrame.Actions[168] == false) Dialog.ExtendMC (Start.stringManager.getTranslation("Loc1_Mertens1_00037"), 166, 167, new int[] {167}, 670);
                        else                      					 Dialog.ExtendMC (Start.stringManager.getTranslation("Loc1_Mertens1_00038"), 166, 167, new int[] {167}, 670);
