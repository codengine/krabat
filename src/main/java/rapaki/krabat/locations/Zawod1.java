...
import rapaki.krabat.anims.IntroDomaPtack;
import rapaki.krabat.anims.LogoPtack;
...
public class Zawod1 extends Mainloc
{
    ...
    public void paintLocation (GenericDrawingContext g)
    {
        ...
        if (IntroStep < 10)
			...
			// hier den Sound eval.
			if ((++Counter) == 30) mainFrame.wave.PlayFile ("sfx/rapak1.wav");
			if (Counter == 60) mainFrame.wave.PlayFile ("sfx/rapak2.wav");
                    }
                ...
                if (IntroStep == 100)
                    {
                        ...
                        ptack1.Flieg (g);
                        mainFrame.scrollx -= 1;
                        if (mainFrame.scrollx < 0) mainFrame.scrollx = 0;
                        if (((ptack2.Flieg (g)) == false) && (mainFrame.scrollx == 0)) IntroStep++;
			evalSound ();
                    }
...
// 		System.out.println (System.currentTimeMillis());
                ...
                if (IntroStep < 102) Farb = FarbenArray[13];
                else Farb = FarbenArray[1];
        ...
        if ((skipActionID != 0) || (nextActionID != 0)) DoAction();
    }
    ...
    private void evalKrabat (GenericDrawingContext g)
    {
		...
		if ((System.currentTimeMillis () - FloetenSpielZeit) <= 21000) {
			...
			{	
			    ...
			    floetenIndex++;
			    if (floetenIndex == 4) floetenIndex = 0;
			}
            ...
            case 104:
                ...
                if ((zwinkerIndex == 0) && (zuffi > 45)) zwinkerIndex = 1;
                else zwinkerIndex = 0;
...
// 			break;
			...
			// mainFrame.player.Play ("2", -133600);
                        if (mainFrame.sprache == 1) outputText = Start.stringManager.getTranslation("Loc1_Zawod1_00036");
                        if (mainFrame.sprache == 2) outputText = Start.stringManager.getTranslation("Loc1_Zawod1_00037");
                        if (mainFrame.sprache == 3) outputText = Start.stringManager.getTranslation("Loc1_Zawod1_00038");
			...
			mainFrame.talkCount += 50; // Zeit fuer Bautzen-Bild kuenstlich verlaengern
                    ...
                    case 12:
                        ...
                        if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (HText1);
                        if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (DText1);
                        if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (NText1);
                    ...
                    case 14:
                        ...
                        if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (HText2);
                        if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (DText2);
                        if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (NText2);
                        outputTextPos = mainFrame.ifont.CenterText (outputText, new GenericPoint (320, 450));
                        IntroStep++;
                        TalkPause = 5;
                        break;  
			...
			FloetenSpielZeit = System.currentTimeMillis ();
                    ...
                    case 101:
                        ...
                        if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (HText3);
                        if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (DText3);
                        if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (NText3);
                        outputTextPos = mainFrame.ifont.CenterText (outputText, MittelPunkt);
                        IntroStep++;
                        TalkPause = 5;
                        break;  
                    ...
                    case 103:
                        ...
                        Zeile4++;
                        if (Zeile4 == ENDZEILE_VIER) IntroStep++;
                        else nextActionID = 0;
                        TalkPause = 5;
                        break;
                    ...
                    case 104:
                        ...
                        mainFrame.Clipset = false;
                        if (mainFrame.sprache == 1) outputText = Start.stringManager.getTranslation("Loc1_Zawod1_00039");
                        if (mainFrame.sprache == 2) outputText = Start.stringManager.getTranslation("Loc1_Zawod1_00040");
                        if (mainFrame.sprache == 3) outputText = Start.stringManager.getTranslation("Loc1_Zawod1_00041");
                        outputTextPos = mainFrame.ifont.KrabatText (outputText);
                        IntroStep++;
                        TalkPause = 3;
                        break;
