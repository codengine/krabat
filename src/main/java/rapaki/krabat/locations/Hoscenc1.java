...
import rapaki.krabat.anims.Dundak;
import rapaki.krabat.anims.Korcmar;
import rapaki.krabat.anims.Pjany;
...
public class Hoscenc1 extends Mainloc 
{
    ...
    private Borderrect brStrolch, brSaeufer;
    private GenericPoint strolchPoint, saeuferPoint;
    private GenericPoint StrolchTalk, SaeuferTalk;
    ...
    public Hoscenc1 (Start caller, int oldLocation) 
    {
        ...
        if (zf > 25) BackgroundMusicPlayer.getInstance ().playTrack (5, true);
        else BackgroundMusicPlayer.getInstance ().playTrack (19, true);
	...
	if (initSound == true)
        ...
        if (showKorcmar == true)	
            {
                ...
                g.drawImage (background, 0, 0, null); 
                if (doorOpen == true) g.drawImage (durje, 390, 105, null);      		
            }		
        ...
        if (mainFrame.Actions[902] == false)
            {    
	...
	if (SoundCountdown > 0) SoundCountdown--;
    
        // Korcmar bewegen
        if ((showKorcmar == true) && (walkReady == false))
            {
        ...
        if (hosc6Rect.IsPointInRect (pKrTemp) == true)
            {
    ...
    public void evalMouseEvent (GenericMouseEvent e)
    {
        ...
        if (mainFrame.invCursor == true)
			...
			nextActionID = 0;
                        ...
                        if (brSaeufer.IsPointInRect (pTemp) == true)
                            {
                        ...
                        if (brStrolch.IsPointInRect (pTemp) == true)
                            {
                                switch (mainFrame.whatItem)
                                    {
                                    case 2: // kij
                        ...
                        if (wobraz1Rect.IsPointInRect (pTemp) == true)
                            {
                                switch (mainFrame.whatItem)
                                    {
                        ...
                        if (wobraz2Rect.IsPointInRect (pTemp) == true)
                            {
                                switch (mainFrame.whatItem)
                                    {
                                    case 16: // honck z blotom
                        ...
                        // Ausreden fuer Stolc
                        if (stolcRect.IsPointInRect (pTemp) == true)
                            {
                                // Extra - Sinnloszeug
                                nextActionID = 175;
                                pTemp = Pstolc;
                        ...
                        // Ausreden fuer Honck
                        if ((honckRect.IsPointInRect (pTemp) == true) && (mainFrame.Actions[902] == false))
                            {
                                // Extra - Sinnloszeug
                                nextActionID = 165;
                                pTemp = Phonck;
    ...
    public void evalMouseMoveEvent (GenericPoint pTemp)
    {
        ...
        if (mainFrame.invCursor == true)
            {
                ...
                Borderrect tmp = mainFrame.krabat.KrabatRect();
                if  ((tmp.IsPointInRect (pTemp) == true) || 
                     (brSaeufer.IsPointInRect (pTemp) == true) || (brStrolch.IsPointInRect (pTemp) == true) ||
                     ((honckRect.IsPointInRect (pTemp) == true) && (mainFrame.Actions[902] == false)) ||
                     (wobraz1Rect.IsPointInRect (pTemp) == true) || (wobraz2Rect.IsPointInRect (pTemp) == true) ||
                     (stolcRect.IsPointInRect (pTemp) == true) || (durjeRect.IsPointInRect (pTemp) == true)) 
                    {
        ...
        // normaler Cursor, normale Reaktion
            ...
            {
                if ((brSaeufer.IsPointInRect (pTemp) == true) ||
                    (brStrolch.IsPointInRect (pTemp) == true) || ((honckRect.IsPointInRect (pTemp) == true) &&
                                                                  (mainFrame.Actions[902] == false)) ||
                    (wobraz1Rect.IsPointInRect (pTemp) == true) || (wobraz2Rect.IsPointInRect (pTemp) == true) ||
                    (stolcRect.IsPointInRect (pTemp) == true) || (durjeRect.IsPointInRect (pTemp) == true)) 
                    {
                        if (Cursorform != 1)
  	...
  	if ((nextActionID > 119) && (nextActionID < 129))
        ...
        switch (nextActionID)
            ...
            case 750:
                ...
                if (mainFrame.sprache == 1) outputText = APH[(int) Math.round (Math.random () * 2)];
                if (mainFrame.sprache == 2) outputText = APD[(int) Math.round (Math.random () * 2)];
                if (mainFrame.sprache == 3) outputText = APN[(int) Math.round (Math.random () * 2)];
		...
		mainFrame.wave.PlayFile ("sfx/hdurjeauf.wav");
            ...
            case 770:
                ...
                if (walkReady == true) nextActionID = 773;
                break;
            ...
            case 777:
                // warten bis ausgelaufen
                if (walkReady == true) nextActionID = 780;
                break;
            ...
            case 790:
                // warten bis ausgelaufen
                if (walkReady == true) nextActionID = 791;
                break;
		...
		SoundCountdown = 100; // Strolch-Sound deaktivieren
            ...
            case 793:
                // warten bis ausgelaufen
                if (walkReady == true) nextActionID = 795;
                break;
    ...
    private void DoAnims()
    {
        switch (AnimID)
            ...
            case 3:
                AnimCounter--;
                if (AnimCounter < 1) AnimID = 4;
                break;
     	  
            case 4:
                // Saeufer - Schnarchen
                if (mainFrame.sprache == 1) AnimOutputText = APH[(int) Math.round (Math.random () * 2)];
                if (mainFrame.sprache == 2) AnimOutputText = APD[(int) Math.round (Math.random () * 2)];
                if (mainFrame.sprache == 3) AnimOutputText = APN[(int) Math.round (Math.random () * 2)];
