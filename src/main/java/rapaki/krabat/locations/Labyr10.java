...
public class Labyr10 extends Mainlaby 
{
  private GenericImage background, lab102; 
  ...
  private void InitLocation (int Richtung)
  {
    ...
    mainFrame.wegGeher.vBorders.addElement (new Bordertrapez (327, 639, 352, 639, 262, 294));
    mainFrame.wegGeher.vBorders.addElement (new Bordertrapez (352, 402, 345, 419, 295, 479));
    mainFrame.wegGeher.vBorders.addElement (new Bordertrapez (326, 338, 327, 369, 224, 261));
    ...
    switch (Richtung)
    {
      case 0: 
    	...
    	case 9:
        // von rechts aus
    		mainFrame.krabat.SetKrabatPos (new GenericPoint (598, 281));
        mainFrame.krabat.SetFacing (9);
        Ausgang = BerechneAusgang (true, true, false, false);
        break;
      case 6: 
        // von oben aus
        mainFrame.krabat.SetKrabatPos (new GenericPoint (340, 243));
        mainFrame.krabat.SetFacing (6);
        Ausgang = BerechneAusgang (false, true, false, true);
        break;
      case 12: 
        // von unten aus
        mainFrame.krabat.SetKrabatPos (new GenericPoint (387, 458));
  ...
  {
    background = getPicture ("gfx/labyrinth/laby10.gif");
    lab102     = getPicture ("gfx/labyrinth/lab10-2.gif");
  ...
  public void paintLocation (GenericDrawingContext g)
  {
    ...
    if (lab102Rect.IsPointInRect (pKrTemp) == true)
    {
      g.drawImage (lab102, 444, 135, null);
    }
