...
import rapaki.krabat.anims.Wudowa;
...
public class Zdzary1 extends Mainloc 
{
    ...
    {
  	if (Userdialog.user == true) Userdialog.evalMouseExitEvent (e);
	...
	switch (nextActionID)
	    ...
	    case 714:
		// User anschauen
		if (mainFrame.sprache == 1) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Zdzary1_00222"));
		if (mainFrame.sprache == 2) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Zdzary1_00223"));
		if (mainFrame.sprache == 3) outputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Zdzary1_00224"));
		outputTextPos = mainFrame.ifont.KrabatText (outputText);
		nextActionID = 715;
		TalkPerson = 3;
		mainFrame.krabat.SetFacing (6);
