...
import rapaki.krabat.anims.WikowarRybow;
import rapaki.krabat.anims.WikowarZita;
...
public class Kulow1 extends Mainloc 
{
    ...
    private boolean showRybowar = true;
	...
	g.drawImage (backright, 640, 0, null);
	if ((AnimLocked == false) && (AnimMCLocked == false))
	    {
		if (showRybowar == true) fischer.drawRybowar (g, TalkPerson, AnimTalkPerson, rybowarUp, 
							      rybowarhoertzu, rybowargibtkrosik, rybowarsuchtzrawc, 
							      octopussyerscheint, rybowarnimmtfisch);
	    }
	else
	    {
		if (showRybowar == true) fischer.drawRybowar (g, TalkPerson, 0, rybowarUp, 
							      rybowarhoertzu, rybowargibtkrosik, rybowarsuchtzrawc, 
							      octopussyerscheint, rybowarnimmtfisch);
	    }
    		                                                  	
	if (octopussyerscheint == true) octopussyerscheint = false;
    
	// Wenn Holzfisch noch da, dann auch zeichnen
	if (mainFrame.Actions[913] == false) 
	    {
	...
	if  ((AnimOutputText != "") && (AnimActive == true) && (AnimLocked == false))
	    {
		// Textausgabe
		GenericRectangle my;
		my = g.getClipBounds();
	...
	if ((AnimID != 0) && (AnimActive == true) && (AnimLocked == false))
	    {
		DoAnims();
	    }		
	...
	if (mainFrame.invCursor == true)
		...
		if (e.getModifiers () != GenericInputEvent.BUTTON3_MASK)
			...
			if ((rybowarLookRect.IsPointInRect (pTemp) == true) && (AnimActive == false))
			...
			// Ausreden fuer Dryba
			if (((drybaLookRect.IsPointInRect (pTemp) == true) && (mainFrame.Actions[913] == false)) && 
			    ((rybowarLookRect.IsPointInRect (pTemp) == false) || (AnimActive == true)))
			    {
				switch (mainFrame.whatItem)
				    {
				    case 12: // kamuski
	...
	if (mainFrame.invCursor == true)
		...
		if ((tmp.IsPointInRect (pTemp) == true) || 
		    ...
		    ((rybowarLookRect.IsPointInRect (pTemp) == true) && (AnimActive == false)) ||
		    ((drybaLookRect.IsPointInRect (pTemp) == true) && (mainFrame.Actions[913] == false)) ||
	...
	switch (nextActionID)
		...
		if (mainFrame.isScrolling == true) return;
		wikowarhoertzu = true;
		...
		mainFrame.inventory.vInventory.removeElement (new Integer (14));
		mainFrame.inventory.vInventory.addElement    (new Integer (15));
		...
		if (mainFrame.sprache == 1)
			...
			if (mainFrame.Actions[150] == false) Dialog.ExtendMC (Start.stringManager.getTranslation("Loc1_Kulow1_00118"), 130, 1000, null, 920);
			else                                 Dialog.ExtendMC (Start.stringManager.getTranslation("Loc1_Kulow1_00119"), 130, 1000, null, 930);
		...
		if (mainFrame.sprache == 2)
			...
			if (mainFrame.Actions[150] == false) Dialog.ExtendMC (Start.stringManager.getTranslation("Loc1_Kulow1_00125"), 130, 1000, null, 920);
			else                                 Dialog.ExtendMC (Start.stringManager.getTranslation("Loc1_Kulow1_00126"), 130, 1000, null, 930);
		...
		if (mainFrame.sprache == 3)
			...
			if (mainFrame.Actions[150] == false) Dialog.ExtendMC (Start.stringManager.getTranslation("Loc1_Kulow1_00132"), 130, 1000, null, 920);
			else                                 Dialog.ExtendMC (Start.stringManager.getTranslation("Loc1_Kulow1_00133"), 130, 1000, null, 930);
    ...
    private void DoAnims()
    {
  	switch (AnimID)
	    ...
	    case 2:
  	  	AnimCounter--;
  	  	if (AnimCounter == 0) AnimID = 3;
  	  	break;
  	  	
	    case 3:
  	  	// 1. Textausgabe
  	  	if (mainFrame.sprache == 1) AnimOutputText = Start.stringManager.getTranslation("Loc1_Kulow1_00156");
  	  	if (mainFrame.sprache == 2) AnimOutputText = Start.stringManager.getTranslation("Loc1_Kulow1_00157");
  	  	if (mainFrame.sprache == 3) AnimOutputText = Start.stringManager.getTranslation("Loc1_Kulow1_00158");
	    ...
	    case 6:
  	  	AnimCounter--;
  	  	if (AnimCounter == 0) AnimID = 7;
  	  	break;
  	  	
	    case 7:
  	  	// 2. Textausgabe
  	  	if (mainFrame.sprache == 1) AnimOutputText = Start.stringManager.getTranslation("Loc1_Kulow1_00159");
  	  	if (mainFrame.sprache == 2) AnimOutputText = Start.stringManager.getTranslation("Loc1_Kulow1_00160");
  	  	if (mainFrame.sprache == 3) AnimOutputText = Start.stringManager.getTranslation("Loc1_Kulow1_00161");
  	  	AnimOutputTextPos = mainFrame.ifont.CenterAnimText (AnimOutputText, rybowarTalk);
  	  	AnimCounter = 10;
  	  	AnimTalkPerson = 33;
  	  	AnimID = 8;
		...
		// 6. Textausgabe (Person wieder aufrichten...
  	  	rybowarsuchtzrawc = false;
   	  	if (mainFrame.sprache == 1) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Kulow1_00171"));
   	  	if (mainFrame.sprache == 2) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Kulow1_00172"));
 	    	if (mainFrame.sprache == 3) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Kulow1_00173"));
  	  	AnimOutputTextPos = mainFrame.ifont.CenterAnimText (AnimOutputText, rybowarTalk);
  	  	AnimCounter = 20;
  	  	AnimTalkPerson = 33;
  	  	AnimID = 24;
	    ...
	    case 501:
  	  	AnimCounter--;
  	  	if (AnimCounter == 0) AnimID = 502;
  	  	break;
  	  	
	    case 502:
  	  	// 1. Textausgabe
  	  	int zuffi = 1;
  	  	if (mainFrame.Actions[138] == false)
		    {
			...
			if (mainFrame.sprache == 1) AnimOutputText = Start.stringManager.getTranslation("Loc1_Kulow1_00174");
			if (mainFrame.sprache == 2) AnimOutputText = Start.stringManager.getTranslation("Loc1_Kulow1_00175");
			if (mainFrame.sprache == 3) AnimOutputText = Start.stringManager.getTranslation("Loc1_Kulow1_00176");
			break;
  	  	      
		    case 1:
			if (mainFrame.sprache == 1) AnimOutputText = Start.stringManager.getTranslation("Loc1_Kulow1_00177");
			if (mainFrame.sprache == 2) AnimOutputText = Start.stringManager.getTranslation("Loc1_Kulow1_00178");
			if (mainFrame.sprache == 3) AnimOutputText = Start.stringManager.getTranslation("Loc1_Kulow1_00179");
			break;
		    }      
  	  	AnimOutputTextPos = mainFrame.ifont.CenterAnimText (AnimOutputText, rybowarTalk);
  	  	AnimCounter = 25;
	    ...
	    case 505:
  	  	AnimCounter--;
  	  	if (AnimCounter == 0) AnimID = 506;
  	  	break;
  	  	
	    case 506:
		// 2. Textausgabe (Person wieder aufrichten...
  	  	rybowarsuchtzrawc = false;
 	    	if (mainFrame.sprache == 1) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Kulow1_00180"));
 	    	if (mainFrame.sprache == 2) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Kulow1_00181"));
		if (mainFrame.sprache == 3) AnimOutputText = mainFrame.ifont.TeileText (Start.stringManager.getTranslation("Loc1_Kulow1_00182"));
  	  	AnimOutputTextPos = mainFrame.ifont.CenterAnimText (AnimOutputText, rybowarTalk);
  	  	AnimCounter = 30;
  	  	AnimTalkPerson = 33;
  	  	AnimID = 507;
