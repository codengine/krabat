...
public class Most2 extends Mainloc2 
{
    ...
    private GenericPoint pohoncPoint;
    private GenericPoint pohoncTalk;
    ...
    private void InitLocation (int oldLocation)
    {
		...
		if (mainFrame.Actions[300] == true)
		...
		else
		    {
                ...
                if (TalRect.IsPointInRect (tp) == true) isTal = true;
                else isTal = false; 
                break;
            case 71:
	...
	if (ismuellermorphing == true)
   	...
   	if (Berglauf == true) g.drawImage (wegstueck, 342, 270, null);
	...
	if (zeigeGras == true) g.drawImage (gras, 188, 290, null);
        ...
        if (mainFrame.invCursor == true)
			...
			nextActionID = 0;
                        ...
                        if (tmp.IsPointInRect (pTemp) == true)
                            {
                                if (setAusnahme == false)
                                    {
                                        nextActionID = 500 + mainFrame.whatItem;
                                    }
                                else
                                    {
                                        if (mainFrame.whatItem == 20) nextActionID = 2000;
                                        if (mainFrame.whatItem == 1)  nextActionID = 2010;
                                        else nextActionID = 500 + mainFrame.whatItem;
                                    }			
                                mainFrame.repaint();
                                return;
                            }	
                        ...
                        if (tp == false) mainFrame.wegGeher.SetzeNeuenWeg (pTemp);
                        mainFrame.repaint();
                    }
        ...
        else
            {
                if (e.getModifiers () != GenericInputEvent.BUTTON3_MASK)
                    {   
                        ...
                        if (tz == false) mainFrame.wegGeher.SetzeNeuenWeg (pTemp);
                        mainFrame.repaint();
                    }
                        ...
                        if (ralbitzSchild.IsPointInRect (pTemp) == true)
                            {
                                ...
                                if (tu == false) mainFrame.wegGeher.SetzeNeuenWeg (pTemp);
                                mainFrame.repaint();
                                return;
                            }
    ...
    {	
        ...
        if (setAusnahme == true) return (false);
    ...
    {
	if (wasserAus == true) return; // wenn nix mehr gespielt werden soll, dann exit
    ...
    private void DoAction ()
    {
  	...
  	if ((nextActionID > 119) && (nextActionID < 129))
		...
		if (Counter < 60) schwein1Tanzt = true;
		if (Counter < 40) schwein2Tanzt = true;
		if (Counter < 20) schwein3Tanzt = true;
		if ((--Counter) > 1) break;
		Counter = 190;
		nextActionID = 2020;
		break;
		...
		// Kutsche faehrt weg...ausfaden
            ...
            case 2655:
                // bis zum Ende warten
                FadeToBlack += 3;
                if (FadeToBlack >= 240) nextActionID = 2658;
                break;		
