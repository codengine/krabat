...
public class Sunow2 extends Mainloc2 
{
	...
	if (mainFrame.krabat.nAnimation != 0)
   	...
   	if (Berglauf == true) g.drawImage (wegstueck, 253, 268, null);
	...
	if (mainFrame.invCursor == true)
		...
		if (e.getModifiers () != GenericInputEvent.BUTTON3_MASK)
			...
			if ((sunowRect.IsPointInRect (pTemp) == true) && (obererAusgang.IsPointInRect (pTemp) == false))
			    {
			...
			if (tg == false) mainFrame.wegGeher.SetzeNeuenWeg (pTemp);
			mainFrame.repaint();
		    }
	...
	// normaler Cursor, normale Reaktion
		...
		if (e.getModifiers () != GenericInputEvent.BUTTON3_MASK)
			...
			if (gh == false) mainFrame.wegGeher.SetzeNeuenWeg (pTemp);
			mainFrame.repaint();
		    }
	...
	if (mainFrame.invCursor == true)
		...
		Borderrect tmp = mainFrame.krabat.KrabatRect();
		if ((sunowRect.IsPointInRect (pTemp) == true) || (tmp.IsPointInRect (pTemp) == true))
		    {
