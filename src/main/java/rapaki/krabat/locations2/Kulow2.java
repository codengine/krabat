...
public class Kulow2 extends Mainloc 
{
	...
	switch (nextActionID)
		...
		if (mainFrame.sprache == 1)
			...
			if (mainFrame.Actions[150] == false) Dialog.ExtendMC (Start.stringManager.getTranslation("Loc2_Kulow2_00106"), 130, 1000, null, 920);
			else                                 Dialog.ExtendMC (Start.stringManager.getTranslation("Loc2_Kulow2_00107"), 130, 1000, null, 930);
		...
		if (mainFrame.sprache == 2)
			...
			if (mainFrame.Actions[150] == false) Dialog.ExtendMC (Start.stringManager.getTranslation("Loc2_Kulow2_00111"), 130, 1000, null, 920);
			else                                 Dialog.ExtendMC (Start.stringManager.getTranslation("Loc2_Kulow2_00112"), 130, 1000, null, 930);
		...
		if (mainFrame.sprache == 3)
			...
			if (mainFrame.Actions[150] == false) Dialog.ExtendMC (Start.stringManager.getTranslation("Loc2_Kulow2_00116"), 130, 1000, null, 920);
			else                                 Dialog.ExtendMC (Start.stringManager.getTranslation("Loc2_Kulow2_00117"), 130, 1000, null, 930);
