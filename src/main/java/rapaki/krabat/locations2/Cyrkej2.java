...
import rapaki.krabat.anims.Fararhor;
...
public class Cyrkej2 extends Mainloc 
{
    ...
    private GenericPoint pfPoint;
    private GenericPoint pfarrerTalk;
        ...
        if (mainFrame.invCursor == true)
            {
                ...
                Borderrect tmp = mainFrame.krabat.KrabatRect();
                if ((tmp.IsPointInRect (pTemp) == true) || (brTuer.IsPointInRect (pTemp) == true))
                    {
    ...
    private void DoAction ()
    {
  	...
  	if ((nextActionID > 119) && (nextActionID < 129))
		...
		mainFrame.wave.PlayFile ("sfx/klopfklopf.wav");
            ...
            case 55:
                // bisschen warten
                if ((--WaitCount) < 1) nextActionID = 57;
                break;
		...
		mainFrame.wave.PlayFile ("sfx/cdurjeauf.wav");
            ...
            case 65:
                // Skip zu MC
                if (openDoorAnim == false) nextActionID = 600;
                break;	  
