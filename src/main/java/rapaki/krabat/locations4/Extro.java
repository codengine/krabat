...
package rapaki.krabat.locations4;

import rapaki.krabat.Start;
import rapaki.krabat.anims.PtackZaRapaka;
...
public class Extro extends Mainloc 
{
    ...
    public void paintLocation (GenericDrawingContext g)
    {
        ...
        if (Scroller == true) g.setClip (kleinesRect);
        ...
        if  ((outputText != "") || (Scroller == true))
            {
                ...
                if (Scroller == true) tempText = scrollerOutputText; 

                // Textausgabe
                GenericRectangle my;
                my = g.getClipBounds();
                if (Scroller == false) g.setClip (0, 0, 644, 484);
    ...
    private void DoAction ()
    {
        ...
        switch (nextActionID)
            ...
            case 10:
                ...
                if (rapakVisible == false) nextActionID = 1000;
                break;
            ...
            case 9000:
                ...
                Scroller = true;
                if (mainFrame.sprache == 1) scrollerOutputText = HScroller;
                if (mainFrame.sprache == 2) scrollerOutputText = DScroller;
                if (mainFrame.sprache == 3) scrollerOutputText = NScroller;
            ...
            case 9010:
                ...
                if (mainFrame.sprache == 1) outputText = HScroller;
                if (mainFrame.sprache == 2) outputText = DScroller;
                if (mainFrame.sprache == 3) outputText = NScroller;
                mainFrame.Clipset = false;
                outputTextPos.y -= 2;
                TalkPerson = 54;
                if (outputTextPos.y < - 1000) nextActionID = 9500;
            ...
            case 9530:
                ...
                FadeToBlack += 3;
                if (FadeToBlack >= 246) nextActionID = 10000;
                break;		
