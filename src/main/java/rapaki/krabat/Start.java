...
import rapaki.krabat.anims.*;
import rapaki.krabat.locations.*;
import rapaki.krabat.locations2.*;
import rapaki.krabat.locations3.*;
import rapaki.krabat.locations4.*;
import rapaki.krabat.main.*;
import rapaki.krabat.platform.*;
...
public class Start implements Runnable
{
   ...
   // private long paintzeit = 0;  // fuer Debugging Benchmark - Anzeige
    ...
    public synchronized final void mousePressed (GenericMouseEvent e)
    {
        ...
        if (currentLocation != null) currentLocation.evalMouseEvent (e);
    ...
    {
        // System.out.print("M");
        if (/*(isWindowactive == false) ||*/ (isListenerActive == false)) return;
    ...
    {
        if (isListenerActive == false) return;
        Clipset = false;
        exit.Activate(1);
    }
	...
	case 102: laden = null;
	    break;	
	case 103: speichern = null;
	    break;	
	case 104: credits = null;
	    break;	
	case 106: karte = null;
	    break;
	case 107: woerterbuch = null;
	    break;          
	case 108: skica = null;
	    break;
        }	          	
    ...
    public synchronized void ConstructLocation (int newLocation)
    {
        ...
        {
            case 0: break;
            case 1: currentLocation = (Mainloc) new Ralbicy1 (this, currLocation);
                break;
            case 2: currentLocation = (Mainloc) new Most1 (this, currLocation);
                break;
            case 3: currentLocation = (Mainloc) new Jitk1 (this, currLocation);
                break;
            case 4: currentLocation = (Mainloc) new Haty1 (this, currLocation);
                break;
            case 5: currentLocation = (Mainloc) new Les1 (this, currLocation);
                break;
            case 6: currentLocation = (Mainloc) new Doma1 (this, currLocation);
                break;
            case 7: currentLocation = (Mainloc) new Sunow1 (this, currLocation);
                break;
            case 8: currentLocation = (Mainloc) new Rapak1 (this, currLocation);
                break;
            case 9: currentLocation = (Mainloc) new Wobzor1 (this, currLocation);
                break;                
            case 10: currentLocation = (Mainloc) new Wjerby1 (this, currLocation);
                break;                
            case 11: currentLocation = (Mainloc) new Polo1 (this, currLocation);
                break;                
            case 12: currentLocation = (Mainloc) new Kupa1 (this, currLocation);
                break;                
            case 13: currentLocation = (Mainloc) new Wjes1 (this, currLocation);
                break;                
            case 14: currentLocation = (Mainloc) new Hojnt1 (this, currLocation);
                break;                
            case 15: currentLocation = (Mainloc) new Njedz1 (this, currLocation);
                break;                
            case 16: currentLocation = (Mainloc) new Wila1 (this, currLocation);
                break;                
            case 17: currentLocation = (Mainloc) new CornyCholmc1 (this, currLocation);
                break;                
            case 18: currentLocation = (Mainloc) new Dubring1 (this, currLocation);
                break;                
            case 19: currentLocation = (Mainloc) new Zdzary1 (this, currLocation);
                break;                
            case 20: currentLocation = (Mainloc) new Mertens1 (this, currLocation);
                break;                
            case 21: currentLocation = (Mainloc) new Kulow1 (this, currLocation);
                break;                
            case 22: currentLocation = (Mainloc) new Cyrkej1 (this, currLocation);
                break;                
                //    case 23: currentLocation = (Mainloc) new pinca1 (this, currLocation);
                //             break;                
            case 24: currentLocation = (Mainloc) new Hoscenc1 (this, currLocation);
                break;                
            case 25: currentLocation = (Mainloc) new Mlyn1 (this, currLocation);
                break;                
            case 26: currentLocation = (Mainloc) new MlynkCornyCholmc1 (this, currLocation);
                break;                
            case 27: currentLocation = (Mainloc) new Jama1 (this, currLocation);
                break;                
            case 28: currentLocation = (Mainloc) new Dzera (this, currLocation);
                break;    
            case 29: currentLocation = (Mainloc) new HojntAuto (this, currLocation);
                break;                     
            case 70: currentLocation = (Mainloc) new Cyrkej2 (this, currLocation);
                break;                
            case 71: currentLocation = (Mainloc) new Doma2 (this, currLocation);
                break;                
            case 72: currentLocation = (Mainloc) new Dubring2 (this, currLocation);
                break;                
            case 73: currentLocation = (Mainloc) new Hojnt2 (this, currLocation);
                break;                
            case 74: currentLocation = (Mainloc) new Jitk2 (this, currLocation);
                break;                
            case 75: currentLocation = (Mainloc) new CornyCholmc2 (this, currLocation);
                break;                
            case 76: currentLocation = (Mainloc) new Kulow2 (this, currLocation);
                break;                
            case 77: currentLocation = (Mainloc) new Labyr122 (this, currLocation);
                break;                
            case 78: currentLocation = (Mainloc) new Les2 (this, currLocation);
                break;                
            case 79: currentLocation = (Mainloc) new Mertens2 (this, currLocation);
                break;                
            case 80: currentLocation = (Mainloc) new Njedz2 (this, currLocation);
                break;                
            case 81: currentLocation = (Mainloc) new Pinca2 (this, currLocation);
                break;                
            case 82: currentLocation = (Mainloc) new Ralbicy2 (this, currLocation);
                break;                
            case 83: currentLocation = (Mainloc) new Rapak2 (this, currLocation);
                break;                
            case 84: currentLocation = (Mainloc) new Sunow2 (this, currLocation);
                break;                
            case 85: currentLocation = (Mainloc) new Wila2 (this, currLocation);
                break;                
            case 86: currentLocation = (Mainloc) new Wjerby2 (this, currLocation);
                break;                
            case 87: currentLocation = (Mainloc) new Wjes2 (this, currLocation);
                break;                
            case 88: currentLocation = (Mainloc) new Wobzor2 (this, currLocation);
                break;                
            case 89: currentLocation = (Mainloc) new Most2 (this, currLocation);
                break;                
            case 90: currentLocation = (Mainloc) new Mlyn2 (this, currLocation);
                break;                
            case 91: currentLocation = (Mainloc) new Inmlyn (this, currLocation);
                break;                
            case 92: currentLocation = (Mainloc) new Swoboda (this, currLocation);
                break;                
            case 93: currentLocation = (Mainloc) new Zdzary2 (this, currLocation);
                break;                
            case 94: currentLocation = (Mainloc) new Jezba (this, currLocation);
                break;                
            case 100: currentLocation = (Mainloc) new Zawod1 (this);
                break;
            case 101: currentLocation = (Mainloc) new Extro (this);
                break;
            case 102: laden = new Wocinic (this);
                newLocation = currLocation; // bei Laden, Speichern, Credits
                break;
            case 103: speichern = new Skladzic (this);
                newLocation = currLocation; // bleibt alte Location bestehen
                break;
            case 104: credits = new Info (this);
                newLocation = currLocation;
                break;
            case 105: currentLocation = (Mainloc) new Install (this);
                break; 
            case 106: karte = new Karta (this);
                newLocation = currLocation; // alte Location bleibt bestehen
                break;
            case 107: woerterbuch = new Slownik (this);
                // woerterbuch = new Slownikcreate (this);
                newLocation = currLocation;
                break;          
            case 108: skica = new Skica (this);
                newLocation = currLocation; // alte Location bleibt bestehen
                break;
            case 109: currentLocation = (Mainloc) new LanguageChooser(this, gameProperties);
            	break;
                // Dresdener Locations
            case 120: currentLocation = (Mainloc) new Kuchnja (this, currLocation);
                    break;                
            case 121: currentLocation = (Mainloc) new Haska (this, currLocation);
                break;                
            case 122: currentLocation = (Mainloc) new Spaniska (this, currLocation);
                break;                
            case 123: currentLocation = (Mainloc) new Hala (this, currLocation);
                break;                
            case 124: currentLocation = (Mainloc) new Komedij (this, currLocation);
                break;                
            case 125: currentLocation = (Mainloc) new Jewisco (this, currLocation);
                break;                
            case 126: currentLocation = (Mainloc) new Murja (this, currLocation);
                break;                
            case 127: currentLocation = (Mainloc) new Terassa (this, currLocation);
                break;                
            case 128: currentLocation = (Mainloc) new Straze (this, currLocation);
                break;                
            case 129: currentLocation = (Mainloc) new Mlynkmurja (this, currLocation);
                break;                
            case 130: currentLocation = (Mainloc) new Hdwor (this, currLocation);
                break;                
            case 131: currentLocation = (Mainloc) new Trepjena (this, currLocation);
                break;                
            case 132: currentLocation = (Mainloc) new Kuchnjaopen (this, currLocation);
                break;                
            case 140: currentLocation = (Mainloc) new Saal (this, currLocation);
                break;                
            case 141: currentLocation = (Mainloc) new Dingl (this, currLocation);
                break;                
            case 142: currentLocation = (Mainloc) new Chodba (this, currLocation);
                break;                
            case 143: currentLocation = (Mainloc) new Casnik (this, currLocation);
                break;                
            case 144: currentLocation = (Mainloc) new Couch (this, currLocation);
                break;                
            case 145: currentLocation = (Mainloc) new Zelen (this, currLocation);
                break;                
            case 146: currentLocation = (Mainloc) new Wonka (this, currLocation);
                break;                
            case 150: currentLocation = (Mainloc) new Cychi (this, currLocation);
                break;                
            case 151: currentLocation = (Mainloc) new Zachod (this, currLocation);
                break;                
            case 152: currentLocation = (Mainloc) new Gang (this, currLocation);
                break;                
            case 153: currentLocation = (Mainloc) new Kapala (this, currLocation);
                break;                
            case 160: currentLocation = (Mainloc) new Panorama (this, currLocation);
                break;
            case 161: currentLocation = (Mainloc) new Stwa (this, currLocation);
                break;
            case 162: currentLocation = (Mainloc) new Zahrodnik (this, currLocation);
                break;                
            case 163: currentLocation = (Mainloc) new Habor (this, currLocation);
                break;                
            case 164: currentLocation = (Mainloc) new Lodz (this, currLocation);
                break;                
            case 170: currentLocation = (Mainloc) new Zastup (this, currLocation);
                break;                
            case 171: currentLocation = (Mainloc) new Manega (this, currLocation);
                break;                
            case 175: currentLocation = (Mainloc) new StareWiki (this, currLocation);
                break;                
            case 180: currentLocation = (Mainloc) new DDKarta (this, currLocation);
                break;                
            case 181: currentLocation = (Mainloc) new Poklad (this, currLocation);
                break;                
            case 200: currentLocation = (Mainloc) new Wotrow (this, currLocation);
                break;                        
            case 201: currentLocation = (Mainloc) new Hrodz (this, currLocation);
                break;                        
            case 202: currentLocation = (Mainloc) new Rowy (this, currLocation);
                break;                        
            case 203: currentLocation = (Mainloc) new Doma4 (this, currLocation);
                break;                        
            default: 
    ...
    public synchronized void ConstructLocation (int newLocation, int Richtung)
    {
        ...
        switch (newLocation)
        {
            ...
            case 51: currentLocation = (Mainloc) new Labyr1 (this, Richtung);
                break;                
            case 52: currentLocation = (Mainloc) new Labyr2 (this, Richtung);
                break;                
            case 53: currentLocation = (Mainloc) new Labyr3 (this, Richtung);
                break;                
            case 54: currentLocation = (Mainloc) new Labyr4 (this, Richtung);
                break;                
            case 55: currentLocation = (Mainloc) new Labyr5 (this, Richtung);
                break;                
            case 56: currentLocation = (Mainloc) new Labyr6 (this, Richtung);
                break;                
            case 57: currentLocation = (Mainloc) new Labyr7 (this, Richtung);
                break;                
            case 58: currentLocation = (Mainloc) new Labyr8 (this, Richtung);
                break;                
            case 59: currentLocation = (Mainloc) new Labyr9 (this, Richtung);
                break;                
            case 60: currentLocation = (Mainloc) new Labyr10 (this, Richtung);
                break;                
            case 61: currentLocation = (Mainloc) new Labyr11 (this, Richtung);
                break;                
            case 62: currentLocation = (Mainloc) new Labyr12 (this, Richtung);
                break;                
            default: 
    ...
    {
        if ((isListenerActive == false) || (isWindowactive == false)) return;
